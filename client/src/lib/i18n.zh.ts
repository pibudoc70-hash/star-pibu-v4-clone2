...
export const zh: I18nContent = {
  ...
  reviews: {
    ...
    nextLabel: "下一个",
    items: [
      { name: "金**", age: "", treatment: "眼下脂肪重置", text: "我的黑眼圈非常严重，术后一个月眼睛就亮了起来。效果自然，非常满意！", platform: "Naver", rating: 5, date: "" },
      { name: "李**", age: "", treatment: "皮秒激光", text: "我有很多色斑，3次治疗后改善明显。肤色也变亮了，很满意。", platform: "Naver", rating: 5, date: "" },
      ...
      { name: "尹**", age: "", treatment: "眼下脂肪重置", text: "考虑眼袋手术很久了，医生在咨询中详细说明，让我消除了顾虑。术后恢复快，效果非常自然，很满意。", platform: "Naver", rating: 5, date: "" },
      { name: "姜**", age: "", treatment: "皮秒激光", text: "困扰已久的色斑经3次治疗后明显淡化。由皮肤科专科医生亲自操作，十分放心。效果超出预期！", platform: "Naver", rating: 5, date: "" },
