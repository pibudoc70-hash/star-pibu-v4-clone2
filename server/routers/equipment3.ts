...
const itemFieldsSchema = z.object({
  ...
  nameZhTw: z.string().max(200).optional(),
  ...
  recoveryZhTw: z.string().max(50).optional(),
  ...
  badgeZhTw: z.string().max(100).optional(),
