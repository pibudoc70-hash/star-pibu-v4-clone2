...
- [ ] 안전 실행 6: Event Card의 static inline style만 제한된 component-scoped class로 이동하는 design pilot을 수행하고 desktop·390px·keyboard focus·reduced motion을 검증 — dynamic data·가격·상세 진입·CTA·다른 카드·Header/Hero/Footer 변경 금지
