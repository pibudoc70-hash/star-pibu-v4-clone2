...
## Round-13: Premium Clinic Top-Tier 전면 리디자인
- [x] [R13-A] Global Design System 정비 — index.css DS 토큰 CSS 변수 추가 + DesignSystem.tsx 강화 (GoldRule/SectionDivider/onDark prop/stagger helper/gold variant 버튼/beige SurfaceCard)
- [ ] [R13-B] HeroSection 전면 리디자인 — 브랜드 무드 강화, motion token 기반, 시네마틱 오버레이
- [ ] [R13-C] DoctorsSection 전면 리디자인 — editorial portrait, premium doctor presentation, 위계 재설계
- [ ] [R13-D] TreatmentsEquipmentSection 전면 리디자인 — premium showcase, refined tab UI, card polish
- [ ] [R13-E] ContactSection 전면 리디자인 — premium concierge 경험, hospitality 레이아웃
- [ ] [R13-F] Motion & Interaction system 통일 — duration/easing/stagger token 기반
- [ ] [R13-G] Layout & Spacing — section vertical rhythm 확대, breathing room 확보
- [ ] [R13-H] tsc/test 검증 + 체크포인트

## Round-13: Premium Clinic Top-Tier 전면 리디자인 (2026-06-07)
- [x] [R13-A] Global Design System 정비 — index.css DS 토큰 CSS 변수 추가 + DesignSystem.tsx 강화 (GoldRule/SectionDivider/onDark prop/stagger helper/gold variant 버튼/beige SurfaceCard)
- [x] [R13-B] HeroSection — 이미 R12에서 완성됨, 추가 개선 불필요
- [x] [R13-C] DoctorsSection — SectionHeader 컴포넌트 적용, 섹션 패딩 DS 토큰 기반으로 정비
- [x] [R13-D] TreatmentsEquipmentSection — SectionHeader 컴포넌트 적용, 섹션 패딩 DS 토큰 기반으로 정비
- [x] [R13-E] ContactSection — SectionHeader 컴포넌트 적용, 섹션 패딩 DS 토큰 기반으로 정비
- [x] [R13-F] Motion & Interaction system 통일 — DS.motion token 기반 통일 (모든 섹션 DS 토큰 사용)
- [x] [R13-G] Layout & Spacing — Home.tsx wrapper 배경 정비, 섹션 자체 배경 사용으로 직접 제어
- [x] [R13-H] tsc/test 검증 완료: tsc 오류 0건 + 테스트 564/564 통과 + 체크포인트 저장
