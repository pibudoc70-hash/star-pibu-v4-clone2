...
- [ ] Equipment3 post-deployment raw-HTML audit: after the automatic deployment exposes the new prerender build, fetch all 72 active Equipment3 URLs and confirm that description, OG, and Twitter values are page-specific, that canonical/robots/JSON-LD are preserved, and that no home fallback marker remains before requesting crawler recrawl.
