...
- [ ] P0 managed workspace 감사 및 상담 오류 비노출: GitHub·운영 DB·예약/OTP/외부 예약 CTA·Header/Hero/Footer/MobileBottomCTA/useChatConfig 동결. 현재 managed workspace revision과 상담 오류 redaction·YouTube ID validation·Facility focus lifecycle·Equipment3 effect-state 구현을 읽기 전용 감사하고, 필요한 경우 ConsultationFormSection 및 focused regression에 한정해 raw backend error UI 비노출을 검증·최소 수정. Phase A 감사와 Phase B 구현을 별도 checkpoint로 저장
