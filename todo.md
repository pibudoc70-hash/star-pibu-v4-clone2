...
- [ ] EVENT skeleton 표시 시간 측정: SpecialEventSection의 initial skeleton visible→query settled duration을 local performance mark와 익명 정수 metric으로 관측하고 focused regression으로 lifecycle cleanup을 검증 — 이벤트 data·가격·상세 진입·CTA·DB 변경 금지
