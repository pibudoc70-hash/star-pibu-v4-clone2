...
- [ ] About zh-TW SEO read-only audit: `/zh-tw/about`의 title·description·canonical·hreflang·OG locale·visible copy·fallback source를 실제 route와 source로 대조해 prerender 확대 가능 여부만 판정 — route·SEO·locale copy 변경 금지
