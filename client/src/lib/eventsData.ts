...
export const events: EventItem[] = [
  {
    ...
    iconType: "zap",
    cta: "이벤트 문의",
    deviceImage: "https://d2xsxph8kpxj0f.cloudfront.net/104196446/FfraVpZBeN8JUDHaejFA3e/cerf-device-v2_f0ba33a0.png",
  ...
  },
  {
    ...
    fullDesc: `지난 울써마지 이벤트에 보내주신 큰 호응에 힘입어 앵콜 이벤트를 진행합니다.\n\n울쎄라피 프라임은 리프팅 만족도 1위 울쎄라피의 최신 업그레이드 버전으로, 더 넓은 면적을 빠르게 커버하며 탁월한 리프팅 효과를 자랑합니다.\n\n써마지 FLX는 4세대 고주파 리프팅의 정점으로, 조시형 원장이 공식 자문의로 활동하는 장비입니다. 피부 깊은 층 콜라겐을 자극해 탄력 개선과 주름 완화에 탁월합니다.\n\n두 가지 프리미엄 리프팅을 동시에 경험하는 특별한 기회를 놓치지 마세요.`,
    highlights: [
    ...
    iconType: "sparkles",
    cta: "이벤트 문의",
    deviceImage: "https://d2xsxph8kpxj0f.cloudfront.net/104196446/FfraVpZBeN8JUDHaejFA3e/ultherapy-prime-v2_a733133e.jpg",
    deviceImageAlt: "울쎄라피 프라임 + 써마지 FLX 장비",
    deviceImage2: "https://d2xsxph8kpxj0f.cloudfront.net/104196446/FfraVpZBeN8JUDHaejFA3e/thermage-flx-device2_f28cc552.png",
  ...
  },
  {
    ...
    desc: "리프팅 만족도 1위 울쎄라피의 최신 버전 '울쎄라피 프라임' 도입을 기념하여 특가 이벤트를 진행합니다.",
    fullDesc: `리프팅 만족도 1위 울쎄라피의 최신 버전 '울쎄라피 프라임' 도입을 기념하여 특가 이벤트를 진행했습니다.\n\n울쎄라피 프라임은 기존 울쎄라피 대비 더 넓은 면적을 빠르게 커버하며, 탁월한 리프팅 효과를 제공합니다.\n\n이 이벤트는 종료되었습니다. 현재 진행 중인 이벤트를 확인해 주세요.`,
    highlights: [
      "울쎄라피 프라임 도입 기념",
      "리프팅 만족도 1위",
      "기존 대비 더 넓은 커버리지",
