...
- [ ] P2-Lint-A11y-1 비예약 접근성 마크업 inventory: 현재 109 lint warnings 중 `jsx-a11y` rule의 비예약 active UI 파일을 분류하고, 첫 파일군에서 native semantics/keyboard/focus/visible UI를 보존하는 최소 수정·focused regression·checkpoint를 수행. 예약/OTP/외부 예약 CTA·Header/Hero/Footer/MobileBottomCTA/useChatConfig·lint rule 비활성화/eslint-disable 추가 금지
