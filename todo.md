...
- [ ] Pain-management redesign brief: user approved option 1 after requesting a rollback point. First checkpoint the current compact disclosure-first home state, then reintroduce a premium three-step card flow, a clearly scoped sedation-operation experience badge, monitoring and pre/post guidance trust badges, and 3–5 pain-management FAQs. Use non-guaranteeing medical copy and a personal-variation notice; preserve all other home sections, hero, header badges, logo, reservation CTA, footer, domains, URLs, SEO route metadata, and operational DB
