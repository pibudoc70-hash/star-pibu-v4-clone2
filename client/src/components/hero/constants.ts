...
export const HERO_IMAGES = {
  ...
  desktopWebp: "/manus-storage/hero-bg-new-desktop_2f8a8ccf_482fcfca.webp",
  /** 데스크톱 배경 (JPEG 폴백) */
  desktopJpg: "/manus-storage/hero-bg-new-desktop_2f8a8ccf_482fcfca.webp",
  /** 모바일 세로 배경 (WebP, max-width: 640px) — 데스크탑 이미지 공용 사용 (STAR DERMATOLOGY 글자 노출) */
  mobilePortraitWebp: "/manus-storage/hero-bg-new-desktop_2f8a8ccf_482fcfca.webp",
  /** 모바일 세로 배경 (JPEG 폴백) */
  mobilePortraitJpg: "/manus-storage/hero-bg-new-desktop_2f8a8ccf_482fcfca.webp",
} as const;

/** 스타피부과 AI 로고 이미지 URL */
// [P0-OPT] PNG (118 KB) → WebP (42.5 KB) 변환으로 73.3 KB 절감
export const HERO_LOGO_IMAGE = "/manus-storage/star_logo_d0ae8bbf.webp";
