...
- [ ] 첨부 5단계: 비예약 React lint·접근성 audit — KeywordTrendsDashboard, Hooks/effect dependency, unused import/type, clickable non-semantic element를 예약/OTP/CTA 동결 범위 밖에서 감사하고, 적용 가능한 최우선 단일 개선만 구현·검증
...
- [ ] 첨부 9단계: 최종 통합 검수 — non-reservation diff·type/lint/DB 없는 unit/build/audit와 예약/OTP/CTA/DB 변경 0건을 최종 확인
