...
- [ ] Reduce only the mobile Pain Management guidance panel's excessive top/bottom whitespace and minimum-height behavior so the three-row panel is shorter. Preserve desktop dimensions, row dividers, icons, approved wording, locale content, booking/OTP, and external reservations; protect mobile compact-height and alignment behavior with regression coverage.
