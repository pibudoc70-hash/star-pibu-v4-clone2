...
const TREATMENTS: Record<string, Treatment[]> = {
  ...
  best: [
    {
      ...
      images: [
        "/manus-storage/ulthera-prime_1_0daba485_b78e0b48.png",
        "/manus-storage/thermage-flx_20a90462_e6b7cf77.png",
      ],
      best: true,
    ...
    },
    {
      ...
      image: "/manus-storage/profound_93be7410_e56130d4.png", best: true,
    ...
    },
    {
      ...
      image: "/manus-storage/treat-sculptra_c3f4b5f6_d019e373.png", best: true,
    ...
    },
    {
      ...
      image: "/manus-storage/stemcell_treatment_card-oGb7XJiuyUVsc7VGWNioEw_639b06c3.webp", best: true,
    ...
    },
    {
      ...
      images: [
        ...
        `/manus-storage/equip-ultrapulse-encore_0c14efd1_22f84aaf.png`,
      ],
      best: true,
    ...
    },
    {
      ...
      images: [
        "/manus-storage/excel-v_70001aa7_cc87addc.png",
        "/manus-storage/adva-tx_nobg_4efd6f20_22664f13.png",
      ],
      imgBg: "#E0F2FE",
      best: true,
    ...
    },
    {
      ...
      images: [
        "/manus-storage/excel-v_70001aa7_cc87addc.png",
        "/manus-storage/enlighten3_nobg_83723c8a_ce8a75f5.png",
      ],
      best: true,
  ...
  lifting: [
    {
      ...
      image: "/manus-storage/ulthera-prime_1_0daba485_b78e0b48.png", best: true,
    ...
    },
    {
      ...
      image: "/manus-storage/thermage-flx_20a90462_e6b7cf77.png", best: true,
    ...
    },
    {
      ...
      image: `/manus-storage/equip-xerf-cropped_d21e359e_16d3dcea.png`, best: true,
    ...
    },
    {
      ...
      image: "/manus-storage/11-Photoroom_2cf898c6_bd3b2d27.png",
  ...
  eye: [
    {
      ...
      image: "/manus-storage/treat-eyelid-new-6Qge5k6ndWTS5nFXDZSXRF_1bdb9103.webp", best: true,
  ...
  rosacea: [
...

    {
      ...
      time: "20~40분", timeEn: "20~40min", timeJa: "20~40分", timeZh: "20~40分钟", recovery: "1~2일", recoveryEn: "1–2 days", recoveryJa: "1〜2日", recoveryZh: "1~2天",
      image: "/manus-storage/adva_card_53fcdcea_ab70377b.png",
      imgBg: "#FFFFFF",
...

    {
      ...
      time: "20~40분", timeEn: "20~40min", timeJa: "20~40分", timeZh: "20~40分钟", recovery: "1~2일", recoveryEn: "1–2 days", recoveryJa: "1〜2日", recoveryZh: "1~2天",
      image: "/manus-storage/bbl_card_86144b4c_e282d4c4.png",
      imgBg: "#FFFFFF",
...

    {
      ...
      time: "20~40분", timeEn: "20~40min", timeJa: "20~40分", timeZh: "20~40分钟", recovery: "1~3일", recoveryEn: "1–3 days", recoveryJa: "1〜3日", recoveryZh: "1~3天",
      image: "/manus-storage/pento1064_card_6653a66e_da75482b.png",
      imgBg: "#FFFFFF",
...

    {
      ...
      time: "20~40분", timeEn: "20~40min", timeJa: "20~40分", timeZh: "20~40分钟", recovery: "1~3일", recoveryEn: "1–3 days", recoveryJa: "1〜3日", recoveryZh: "1~3天",
      image: "/manus-storage/lumenis_v_card_03c774b0_783e37e1.png",
      imgBg: "#FFFFFF",
...

    {
      ...
      time: "20~40분", timeEn: "20~40min", timeJa: "20~40分", timeZh: "20~40分钟", recovery: "1~3일", recoveryEn: "1–3 days", recoveryJa: "1〜3日", recoveryZh: "1~3天",
      image: "/manus-storage/cynergy_card_1cb99049_c1dfb97b.png",
      imgBg: "#FFFFFF",
  ...
  pigment: [
    ...
    },
    {
      ...
      image: "/manus-storage/enlighten3_nobg_83723c8a_ce8a75f5.png", best: true,
    ...
    },
    {
      ...
      time: "20~40분", timeEn: "20~40min", timeJa: "20~40分", timeZh: "20~40分钟", recovery: "당일~3일", recoveryEn: "Same day–3 days", recoveryJa: "当日〜3日", recoveryZh: "当天~3天",
      image: "/manus-storage/lumenis-one_558f8b74_b439c8eb.png",
      youtubeUrl: "https://www.youtube.com/embed/rA_n4hbY5Dc",
  ...
  scar: [
    ...
    },
    {
      ...
      image: "/manus-storage/joule-fractional-laser_5152ce2e_eb35b3ea.jpg",
    ...
    },
    {
      ...
      image: "/manus-storage/halo-hybrid-laser_bf04f00b_aed72664.jpeg",
  ...
  volume: [
    {
      ...
      image: "/manus-storage/7IUeNj7YG383_91ad3b5b_b961c93e.jpg", best: true,
    ...
    },
    {
      ...
      image: "/manus-storage/stemcell_9034d023_69e8c03e.png",
    ...
    },
    {
      ...
      time: "30~60분", timeEn: "30~60min", timeJa: "30~60分", timeZh: "30~60分钟", recovery: "당일 일상", recoveryEn: "Same day", recoveryJa: "当日", recoveryZh: "当天",
      image: "/manus-storage/exosome_treatment_card-FL5KNDXVdmJCtUV4DFoGSD_a03acdf5.webp",
    ...
    },
    {
      ...
      time: "30~60분", timeEn: "30~60min", timeJa: "30~60分", timeZh: "30~60分钟", recovery: "당일 일상", recoveryEn: "Same day", recoveryJa: "当日", recoveryZh: "当天",
      badge: "2년 지속", badgeEn: "2-Year Effect", badgeJa: "2年持続", badgeZh: "效果持续2年", badgeColor: "#9C5FA5",
      image: "/manus-storage/treat-sculptra_c3f4b5f6_d019e373.png",
      detail: "스컬트라(Sculptra)는 PLLA(폴리-L-락틱산) 성분의 생체 자극형 콜라겐 자극제입니다. 일반 히알루론산 필러처럼 즉각적인 볼륨 효과를 내는 것이 아니라, 주입 후 수개월에 걸쳐 피부 스스로 콜라겐을 생성하도록 유도합니다. 이 때문에 결과가 매우 자연스럽고, 효과가 평균 2년 이상 지속됩니다. FDA 승인 성분으로 안전성이 공인되어 있으며, 볼 꺼짐·팔자주름·관자놀이 볼륨 감소 등 다양한 부위에 활용할 수 있습니다.",
    ...
    },
    {
      ...
      image: "/manus-storage/7IUeNj7YG383_91ad3b5b_b961c93e.jpg",
  ...
  botox: [
    {
      ...
      image: "/manus-storage/botox_552ff42a_fa3d41b2.png",
    ...
    },
    {
      ...
      image: "/manus-storage/filler_79748c4a_221edb80.png",
    ...
    },
    {
      ...
      time: "20~30분", timeEn: "20~30min", timeJa: "20~30分", timeZh: "20~30分钟", recovery: "1~3일", recoveryEn: "1–3 days", recoveryJa: "1〜3日", recoveryZh: "1~3天",
      image: "/manus-storage/0dVRx3DuVpWY_30a10709_17715098.jpg",
    ...
    },
    {
      ...
      image: "/manus-storage/IkzStH3azHFL_d72284cb_0b6299ad.webp",
  ...
  acne_laser: [
    {
      ...
      image: "/manus-storage/aviclear_3d94823e_d47688ce.png", best: true,
    ...
    },
    {
      ...
      image: "/manus-storage/gKokBoh3bDWm_b8ea202e_b642b1d1.jpg",
    ...
    },
    {
      ...
      image: "/manus-storage/RypUEm7gjHfk_0760fc35_111faf83.png",
    ...
    {      name: "네오젠 플라즈마",
      ...
      image: "/manus-storage/YgF34hnTbXog_e46e8323_fc2a8c2d.png",
  ...
  acne: [
    {
      ...
      image: "/manus-storage/HEkn0mzQWyoC_4d1c0020_344c469f.jpeg",
  ...
  vitiligo: [
    ...
    },
    {
      ...
      image: "/manus-storage/3PticSr0g4jr_e69d1049_93cf9008.jpg",
  ...
  stem_cell: [
    {
      ...
      badge: "자가세포", badgeEn: "Autologous Cells", badgeJa: "自家細胞", badgeZh: "自体细胞", badgeColor: "#2E7D32",
      image: "/manus-storage/stemcell_treatment_card-oGb7XJiuyUVsc7VGWNioEw_639b06c3.webp",
