...
- [ ] Analytics 7일 기준선 실행 가능성 확인: current Umami event 수신·dashboard access·기간 데이터 존재 여부를 read-only로 확인하고, 7일 경과가 필요한 경우 start date·target event·다음 확인일만 운영 기록 — endpoint/website ID/script/CTA/예약 코드 변경 금지
