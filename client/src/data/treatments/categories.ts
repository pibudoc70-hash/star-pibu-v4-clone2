...
export const CATEGORIES: Category[] = [
  { id: "best",       label: "Best 시술",          labelEn: "BEST",          labelJa: "ベスト施術",          labelZh: "精選項目",          labelZhTw: "精選療程",
  ...
  { id: "lifting",    label: "리프팅·탄력",        labelEn: "LIFTING",       labelJa: "リフティング・弾力",  labelZh: "提升·弹力",          labelZhTw: "拉提·緊緻",
  ...
  { id: "eye",        label: "눈밑지방재배치",     labelEn: "EYE",           labelJa: "目の下の脂肪再配置", labelZh: "眼下脂肪重置",       labelZhTw: "眼袋脂肪重置",
  ...
  { id: "vitiligo",   label: "백반증",             labelEn: "VITILIGO",      labelJa: "白斑症",              labelZh: "白癜风",             labelZhTw: "白斑症",
  ...
  { id: "pigment",    label: "색소·문신",           labelEn: "PIGMENT",       labelJa: "色素・タトゥー",      labelZh: "色素·纹身",          labelZhTw: "色素·刺青",
  ...
  { id: "scar",       label: "흉터·모공",           labelEn: "SCAR",          labelJa: "傷跡・毛穴",          labelZh: "疤痕·毛孔",          labelZhTw: "疤痕·毛孔",
  ...
  { id: "acne_laser", label: "여드름",              labelEn: "ACNE",          labelJa: "ニキビ",              labelZh: "痘痘",               labelZhTw: "痘痘",
  ...
  { id: "rosacea",    label: "홍조·혈관",           labelEn: "ROSACEA",       labelJa: "紅潮・血管",          labelZh: "红肌·血管",          labelZhTw: "泛紅·血管",
  ...
  { id: "acne",       label: "액취증·다한증",       labelEn: "HYPERHIDROSIS", labelJa: "腋臭・多汗症",        labelZh: "腋臭·多汗症",        labelZhTw: "腋臭·多汗症",
  ...
  { id: "fungus",     label: "손·발톱무좀",         labelEn: "NAIL FUNGUS",   labelJa: "爪水虫",              labelZh: "甲癣",               labelZhTw: "灰指甲",
  ...
  { id: "psoriasis",  label: "건선·아토피",         labelEn: "PSORIASIS",     labelJa: "乾癬・アトピー",      labelZh: "银屑病·特应性",      labelZhTw: "乾癬·異位性",
  ...
  { id: "volume",     label: "볼륨·부스터",         labelEn: "VOLUME",        labelJa: "ボリューム・ブースター", labelZh: "丰盈·提亮",         labelZhTw: "豐盈·亮澤",
  ...
  { id: "botox",      label: "보톡스·필러",         labelEn: "BOTOX",         labelJa: "ボトックス・フィラー", labelZh: "肉毒素·填充",        labelZhTw: "肉毒桿菌·玻尿酸",
  ...
  { id: "stem_cell",  label: "줄기세포 치료",        labelEn: "STEM CELL",     labelJa: "幹細胞治療",          labelZh: "干细胞治疗",         labelZhTw: "幹細胞治療",
...
export function getCatLabel(cat: Category, lang: string): string {
  ...
  if (lang === "zh-TW" && cat.labelZhTw) return cat.labelZhTw;
