...
- [ ] Custom notification feature: confirm whether notifications are visitor-facing site notices, administrator alerts, or browser push notifications; once approved, implement only the agreed display channel, trigger, audience, persistence, localization, and close/dismiss behavior without changing reservation/OTP, external booking CTAs, domains, or operational DB outside the approved design
