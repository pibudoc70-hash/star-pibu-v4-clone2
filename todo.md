...
- [ ] EVENT 캐시 상태별 익명 로딩 비교: cold·TanStack stale cache·fresh cache 상태에서 SpecialEventSection의 skeleton/metric 발생 조건과 duration을 local/actual browser에서 비교하고, event payload·ID·가격·사용자·예약·의료 정보를 수집하지 않음
