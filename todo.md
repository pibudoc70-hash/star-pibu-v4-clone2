...
- [ ] 병원 승인 의존 카피 동기화 입력 확인: 1:1·10,000명·직접 진료·의료 결과/통증 claim별 evidence·approved Korean wording·approver·verified date를 수령한 경우에만 claim family별 동기화를 시작하고, 미수령이면 변경 없이 보류 기록 유지
