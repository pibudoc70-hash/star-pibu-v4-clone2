...
- [ ] 익명 lazy mount 지연 관측: section selector·mount 요청부터 target 존재까지의 정수 ms만 기존 Umami custom event 경계로 측정하고, PII·URL·예약·의료·event data·사용자 입력은 전송하지 않음 — analytics policy·tracking idle 조건·CTA 변경 금지
