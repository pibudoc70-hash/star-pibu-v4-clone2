...
describe("ManagementDeviceFaq", () => {
  it("shows every prepared management-device FAQ using the existing SonoFill structure", () => {
    ...
    expect(screen.getAllByText("관리 전 무엇을 확인하나요?")).toHaveLength(MANAGEMENT_DEVICES.length);
