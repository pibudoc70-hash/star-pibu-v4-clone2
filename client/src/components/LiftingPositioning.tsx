...
import { LIFTING_FAQS, LIFTING_HOME_SUMMARY, LIFTING_POSITIONING_TITLES, type LiftingPositioningLang } from "@shared/liftingPositioning";
...
export function LiftingPositioningSummary() {
  ...
  return (
    <section className="home-surface-a bg-[#fbf8f2] md:bg-[#FAF8F5] border-y border-[#eadfcd] py-6 md:py-8" aria-labelledby="lifting-positioning-title">
