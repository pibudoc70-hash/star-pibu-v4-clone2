...
export const ja: I18nContent = {
  ...
  reviews: {
    ...
    ratingSource: "Naverレビューに基づく",
    moreReviews: "もっと見る",
    swipeHint: "← スワイプ →",
    prevLabel: "前へ",
    nextLabel: "次へ",
    items: [
      { name: "金**", age: "", treatment: "目の下の脂肪再配置", text: "クマがとても酷かったのですが、施術後1ヶ月で目がぱっと明るくなりました。自然で満足です！", platform: "Naver", rating: 5, date: "" },
      ...
      { name: "尹**", age: "", treatment: "目の下の脂肪再配置", text: "目の下の手術を長年考えていましたが、先生の丁寧な説明で安心して決めました。回復も早く、結果も自然で大満足です。", platform: "Naver", rating: 5, date: "" },
