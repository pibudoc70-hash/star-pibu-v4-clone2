...
- [ ] Attached modification proposal: inspect the user-provided document, translate its concrete approved requirements into narrow code-verifiable tasks, and implement only changes that are compatible with current SEO, accessibility, routing, reservation/OTP, CTA, database, and deployment boundaries. Verify each implemented item before publishing.
