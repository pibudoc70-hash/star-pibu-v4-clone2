...
- [ ] 후속 실행 2: event·doctor·about 주요 landing route의 current render·locale·canonical·data freshness·build cost를 read-only로 감사해 prerender 확대 여부만 판정 — route·SEO·prerender 구현 변경 금지
