...
- [ ] below-fold skeleton timing 확대: event 외 초기 fetch skeleton을 가진 1개 비예약 section만 선택해 visible→query settled의 local performance mark·익명 정수 metric·cleanup을 추가하고, event data·가격·CTA·DB·예약 코드 변경 금지
