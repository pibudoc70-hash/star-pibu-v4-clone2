...
describe("UltheraThermagePromotionPopup", () => {
  ...
  it("provides an accessible close control without a today-hide checkbox", () => {
    ...
    expect(screen.getByRole("button", { name: "닫기" })).toHaveClass("bottom-[-4rem]", "left-1/2", "h-12", "min-w-28", "-translate-x-1/2", "bg-[var(--color-star-navy)]", "text-white", "md:-right-14", "md:top-0", "md:bottom-auto");
