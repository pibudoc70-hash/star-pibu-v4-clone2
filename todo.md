...
- [ ] P2-Lint 비예약 경고 정리: current 111 lint warnings를 예약/OTP/동결 범위와 non-reservation 파일군으로 분류하고, 첫 non-reservation warning file군만 behavior-preserving으로 정리·검증·checkpoint. lint rule 비활성화·eslint-disable 추가 금지
