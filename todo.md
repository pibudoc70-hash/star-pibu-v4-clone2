...
- [ ] Attached proposal Step 0: make no code changes while verifying the listed SpecialEventSection, EventCard, storage cache, Vite manual-chunk, hero image, and frozen-test prerequisites; record the actual baseline, diff status, and deviations in `reports/step-0.md` and `reports/step-0.diff`. Stop for user approval before any Step 1–4 implementation.
