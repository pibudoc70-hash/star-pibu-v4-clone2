...
describe("approved logo asset recovery", () => {
  ...
  it("uses the supplied mobile logo through the direct storage endpoint and removes broken paths", () => {
    expect(heroConstantsSource).toContain('HERO_MOBILE_LOGO_IMAGE = "/api/storage/star-logo-mobile_77b7502d_83869d29.webp"');
    ...
    expect(heroConstantsSource).not.toContain('/manus-storage/star-logo-mobile_77b7502d_83869d29.webp');
