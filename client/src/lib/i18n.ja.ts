...
export const ja: I18nContent = {
  ...
  about: {
    label: "クリニック紹介",
    title: "スター皮膚科について",
    desc: "釜山・西面交差点の前に位置するスター皮膚科は、2006年に開設して以来、患者様のご期待に応え、皆様に美しさと最高の診療結果をお届けするため、日々努力を重ねております。皮膚科専門医としての使命を持って、継続的に最新のレーザー機器を導入し、患者様一人ひとりの肌タイプに最適化された診療システムを構築しています。",
    stats: [
      { num: "20年+", label: "専門医歴" },
      { num: `${_n_ja}${STAT_UNITS.cases.ja}`, label: "目の下のクマ治療" },
      { num: "50+", label: "レーザー機器" },
    ],
    values: [
      { letter: "S", title: "一人ひとりを大切に", desc: "すべての患者様は私たちにとって最も大切な方です。お一人お一人のお悩みに耳を傾ける1対1のオーダーメイド診療を実践しています。" },
      { letter: "T", title: "高水準の施術", desc: "多様なプレミアムレーザーと先進医療技術により、常に高水準の治療結果を提供します。" },
      { letter: "A", title: "快適な環境", desc: "予約制により待ち時間を短縮し、安心して施術に集中できる快適な環境を提供します。" },
  ...
  access: {
    ...
    transitLabel: "交通機関",
    transitDesc: "地下鉄西面駅５番・７番出口から徒歩3分",
    parkingLabel: "駐車場",
    ...
    mapPopupWalkLabel: "徒歩3分",
  },
  directions: {
    title: "アクセス", subtitle: "お気軽にお越しください。", addressLabel: "住所", phoneLabel: "電話", hoursLabel: "診療時間",
    copyAddress: "住所をコピー", copiedAddress: "コピーしました", kakaoMap: "KakaoMapで見る", naverMap: "Naver Mapで見る", googleMaps: "Google マップで経路を見る", mapTitle: "スター皮膚科の所在地地図",
    ...
    list: [
      {
        ...
        specialties: ["クマ取り", "リフトアップ", "ウルセラ", "サーマクール", "傷跡治療", "色素治療", "白斑症", "タトゥー除去", "ボトックス", "フィラー"],
      },
      {
        id: 1,
        name: "ウ・ヘジン",
        ...
        specialties: ["リフトアップ", "ウルセラ", "サーマクール", "傷跡治療", "色素治療", "皮膚疾患", "タトゥー除去", "爪水虫", "ボトックス"],
      },
      {
        id: 2,
        name: "イ・ギウク",
        ...
        specialties: ["リフトアップ", "ウルセラ", "サーマクール", "色素治療", "白斑症", "皮膚疾患", "タトゥー除去", "爪水虫"],
      },
    ],
    tagline: "肌の印象が変わる瞬間、専門医の審美眼が違いを生みます。",
  ...
  treatments: {
    label: "施術案内",
    title: "主要施術・設備",
    subtitle: "20年の経験を持つ皮膚科専門医による施術と、充実したプレミアムレーザー機器",
    sortLabel: "並び替え",
    sortPopular: "人気順",
    sortName: "名前順",
    sortTime: "所要時間順",
    ...
    caution: "注意事項",
    categories: [
      { name: "リフトアップ・弾力", items: ["ウルセラプライム", "サーマクールFLX", "XERF", "シルエットリフト"] },
      { name: "ボリューム・注射", items: ["スカルプトラ", "ヒアルロン酸フィラー", "ボトックス"] },
      { name: "目の下・輪郭", items: ["目の下の脂肪再配置", "ランチタイム目の下レーザー", "汗管腫除去"] },
  ...
  results: {
    ...
    treatmentResults: [
      { treatment: "目の下の脂肪再配置", period: "施術後4週", improvements: ["クマ改善", "目の下の膜らみ解消", "自然な目の下ライン"] },
      { treatment: "サーマクールFLX", period: "施術後3ヶ月", improvements: ["肌の弾力強化", "コラーゲン再生", "全体的な肌改善"] },
      { treatment: "ウルセラプライム", period: "施術後6週", improvements: ["SMAS層リフトアップ", "肌の弾力改善", "シワ改善"] },
    ...
    items: [
      {
        equipment: "ウルセラ",
        questions: [
          { q: "ウルセラとはどんな施術ですか？", a: "ウルセラは超音波（HIFU）エネルギーを使ったリフトアップ施術で、皮膚の深部に熱を届けてコラーゲンを再生させます。手術なしで肌を引き上げる効果があります。" },
      ...
      },
      {
        equipment: "サーマクール",
        questions: [
          { q: "サーマクールとウルセラの違いは？", a: "サーマクールはRF（高周波）エネルギーを使用し、ウルセラは超音波を使用します。サーマクールは皮膚表面から深層まで均一に熱を届けます。両施術を組み合わせるとより良い効果が得られます。" },
      ...
      },
      {
        equipment: "XERF（ザーフ）",
        questions: [
          { q: "XERFとはどんな施術ですか？", a: "XERFは高周波を使った最新リフトアップ技術で、短い施術時間と優れた効果が特徴です。肌の弾力改善とリフトアップ効果が同時に現れます。" },
  ...
  consultation: {
    ...
    concernPlaceholder: "例：目の下の脂肪、リフトアップ、色素など",
    messageLabel: "相談内容",
