...
const DOMAIN_ERROR_MESSAGES: Record<string, Record<Lang, string>> = {
  ...
  OTP_LOCKED: {
    ...
    "zh-TW": "驗證嘗試次數過多，請稍後再試或透過KakaoTalk聯絡我們。",
  },
  OTP_EXPIRED: {
