...
- [ ] Attached proposal 2: inspect the user-provided document, translate its concrete requirements into narrow code-verifiable tasks, and implement only changes compatible with current SEO, accessibility, routing, reservation/OTP, CTA, database, asset-storage, and deployment boundaries. Verify each implemented item before publishing.
