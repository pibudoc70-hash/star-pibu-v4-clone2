...
export const ko: I18nContent = {
  ...
  access: {
    ...
    transitLabel: "대중교통",
    transitDesc: "지하철 서면역 5번·7번 출구 도보 3분",
    parkingLabel: "주차",
    ...
    mapPopupWalkLabel: "도보 3분",
  },
  directions: {
    title: "찾아오시는 길", subtitle: "스타피부과 쉽게 찾아보세요.", addressLabel: "주소", phoneLabel: "전화", hoursLabel: "진료 시간",
    copyAddress: "주소 복사", copiedAddress: "복사됨", kakaoMap: "카카오맵으로 보기", naverMap: "네이버지도로 보기", googleMaps: "Google 지도에서 길찾기", mapTitle: "스타피부과 위치 지도",
...
안전하고 효과적인 치료를 통해 여러분의 피부 건강을 지켜드리겠습니다.`,
  ...
  treatments: {
    ...
    modalSessions: "권장 횟수",
    modalEffect: "기대 효과",
    modalDetailBtn: "자세히 보기",
    modalDetailLoading: "페이지 여는 중…",
    ...
    items: [
      {
        equipment: "울쎄라피 프라임",
        questions: [
          { q: "울쎄라피 프라임은 어떤 시술인가요?", a: "울쎄라피 프라임은 초음파(HIFU) 에너지를 이용한 리프팅 시술로, 피부 깊숙이 열을 전달하여 콜라겐을 재생시킵니다. 수술 없이 피부를 당겨주는 효과가 있습니다." },
      ...
      },
      {
        equipment: "써마지",
        questions: [
          { q: "써마지와 울쎄라피 프라임의 차이점은?", a: "써마지는 RF(고주파) 에너지를 사용하며, 울쎄라피 프라임은 초음파를 사용합니다. 써마지는 피부 표면부터 깊은 층까지 균일하게 열을 전달하며, 두 시술을 병용하면 더 좋은 효과를 얻을 수 있습니다." },
  ...
  consultation: {
    ...
    title: "온라인 상담 신청",
    subtitle: "전문의가 직접 검토하고 연락드립니다",
    nameLabel: "성함",
    namePlaceholder: "성함을 입력해주세요",
    phoneLabel: "연락처",
    phonePlaceholder: "010-0000-0000",
    concernLabel: "희망 시술 / 고민 부위",
    concernPlaceholder: "예: 눈밑지방, 리프팅, 색소 등",
    messageLabel: "상담 내용",
    messagePlaceholder: "피부 고민이나 원하시는 시술에 대해 자유롭게 적어주세요",
    privacyLabel: "개인정보 수집·이용에 동의합니다",
    privacyLink: "개인정보처리방침",
    submitBtn: "상담 신청하기",
    submitting: "신청 중...",
    successTitle: "상담 신청이 완료되었습니다",
    successDesc: "빠른 시간 내에 전화로 연락드리겠습니다.",
    successNote: "평일 09:00–19:00 / 토요일 09:00–14:00 운영",
    resetBtn: "새 상담 신청",
    errorRequired: "필수 항목입니다",
    errorPhone: "올바른 연락처 형식이 아닙니다",
    errorMessage: "상담 내용을 5자 이상 입력해주세요",
    errorPrivacy: "개인정보 수집에 동의해주세요",
    errorRateLimit: "잠시 후 다시 시도해주세요",
    errorGeneric: "오류가 발생했습니다. 잠시 후 다시 시도해주세요",
    quickTitle: "빠른 문의",
    quickPlaceholder: "궁금하신 점을 간단히 남겨주세요",
    quickBtn: "문의하기",
    concerns: [
      "눈밑지방재배치",
      "리프팅 (울쎄라/써마지)",
