...
- [ ] 첨부 7단계: CI·테스트 환경 audit — active CI의 pnpm/frozen lockfile/type/lint/unit/integration 경계와 nested backup workflow를 read-only로 감사; 예약/OTP 테스트·workflow 변경은 별도 승인 전 보류
