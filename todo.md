...
- [ ] Desktop EVENT banner hover scale: each visible event banner/image should receive a pointer-hover-only smooth scale effect while preserving event href, keyboard behavior, mobile layout and price/VAT content. Add focused regression·rendered hover verification·independent checkpoint
