...
- [ ] Genspark v2 6-action 선별 적용 감사: current JSON-LD·breadcrumb·article/content hub·landing route·Naver template·CWV asset pipeline을 read-only로 inventory. 허위 후기·가격·효과·원장/심의 정보·대량 신규 콘텐츠는 의료광고·사실 검증 전 보류하고, existing source와 중복되지 않는 단일 technical SEO 또는 performance 항목만 regression-first 적용. URL·다국어 route·예약/OTP/외부 예약 CTA·운영 DB 변경 금지
