...
- [ ] Desktop Hero CTA hover transition: desktop pointer-hover capable environment에서 existing external booking/phone href는 보존하고 Hero CTA의 color/background/border transition만 추가. mobile CTA and booking behavior 변경 금지; focused regression·actual hover verification·independent checkpoint required
