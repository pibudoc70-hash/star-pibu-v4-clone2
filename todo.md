...
- [ ] Hero text contrast overlay: Hero background 위 text area에 pointer-events-none의 low-opacity dark gradient overlay를 추가해 desktop/mobile text contrast만 보강. image source·layout geometry·motion·CTA behavior 변경 금지; focused regression·actual rendered verification·independent checkpoint required
