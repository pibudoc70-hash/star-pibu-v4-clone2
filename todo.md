...
- [ ] Refine only the mobile Pain Management section's composition: establish a clearer compact-card rhythm, balanced section-to-card spacing, consistent 44px+ disclosure touch targets, and comfortable expanded-detail spacing. Preserve desktop layout, approved medical wording, accordion behavior, locale content, booking/OTP, and external reservations; verify at 390px and desktop with accessibility regressions.
