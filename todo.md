...
- [ ] 첨부 6단계: lazy loading·bundle audit — static/dynamic import 충돌, page-level fallback, Markdown/Mermaid/KaTeX/highlighter 및 index HTML initial injection을 read-only로 비교하고 단일 안전 개선만 제안·검증
