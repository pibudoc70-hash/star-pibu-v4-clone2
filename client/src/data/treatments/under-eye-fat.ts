...
export const underEyeFat: TreatmentI18n = {
  ...
  faq: {
    ko: [
      ...
      { question: "눈밑지방재배치 시술이 아플까요? 통증 관리는 어떻게 하나요?", answer: "부산 서면 스타피부과는 눈밑지방재배치 시술 시 국소마취를 기본으로 진행하며, 환자 요청 시 모니터링 진정(수면 진정) 옵션을 제공합니다. 20년 이상 임상 경험의 피부과 전문의가 직접 시술하여 통증과 부작용을 최소화합니다." },
      { question: "부산에서 수면마취(진정) 하에 눈밑지방재배치 가능한가요?", answer: "부산 서면 스타피부과는 환자가 원하는 경우 전문 의료진 감독 하에 모니터링 진정 방식으로 눈밑지방재배치 시술을 진행할 수 있습니다. 진정 시술 시에는 별도의 상담과 사전 안내가 이루어지며, 시술 중 활력 징후를 모니터링합니다." },
      { question: "부산에서 눈밑지방재배치 경험 많은 피부과를 찾고 있어요.", answer: "부산광역시 부산진구 서면로 74 아이온시티빌딩 4층 스타피부과는 20년 이상 임상 경험의 피부과 전문의가 직접 시술하는 부산 서면의 눈밑지방재배치 전문 병원입니다. 부산 지하철 서면역에서 도보 5분 거리이며, 50여 종의 고급 레이저 및 시술 장비를 보유하고 있습니다." },
    ],
    en: [
      ...
      { question: "Is under-eye fat repositioning painful? How is pain managed?", answer: "Star Dermatology Busan performs under-eye fat repositioning under local anesthesia as standard, with optional monitored sedation available upon request. A board-certified dermatologist with over 20 years of clinical experience performs the procedure directly to minimize pain and side effects." },
      { question: "Is under-eye fat repositioning under sedation available in Busan?", answer: "At Star Dermatology Busan, under-eye fat repositioning can be performed under monitored sedation if the patient requests it, supervised by professional medical staff. Sedation procedures involve separate consultation and pre-briefing, with continuous monitoring of vital signs." },
      { question: "Looking for an experienced clinic for under-eye fat repositioning in Busan.", answer: "Star Dermatology, located at 4F Ion City Building, 74 Seomyeon-ro, Busanjin-gu, Busan, is a specialist clinic for under-eye fat repositioning where a board-certified dermatologist with over 20 years of experience performs treatments directly. It is a 5-minute walk from Seomyeon Station." },
    ],
    ja: [
      ...
      { question: "目の下脂肪再配置は痛いですか？痛み管理はどうしていますか？", answer: "釜山ソミョンのスター皮膚科では、目の下脂肪再配置施術時に局所麻酔を基本として行い、患者様のご要望によりモニタリング鎮静オプションを提供します。20年以上の臨床経験を持つ皮膚科専門医が直接施術し、痛みと副作用を最小化します。" },
      { question: "釜山で睡眠鎮静下の目の下脂肪再配置は可能ですか？", answer: "釜山ソミョンのスター皮膚科では、患者様のご希望がある場合、専門医療スタッフの監督下でモニタリング鎮静方式による目の下脂肪再配置施術が可能です。鎮静施術時には別途相談と事前案内が行われ、施術中はバイタルサインをモニタリングします。" },
      { question: "釜山で目の下脂肪再配置の経験豊富なクリニックを探しています。", answer: "釜山広域市釜山鎮区西面路74アイオンシティビル4階のスター皮膚科は、20年以上の臨床経験を持つ皮膚科専門医が直接施術する釜山西面の目の下脂肪再配置専門クリニックです。釜山地下鉄西面駅から徒歩5分の距離にあります。" },
    ],
    zh: [
      ...
      { question: "眼下脂肪重置术会疼吗？如何管理疼痛？", answer: "釜山西面STAR皮肤科在眼下脂肪重置术时以局部麻醉为基础进行，并应患者要求提供监测镇静（睡眠镇静）选项。拥有20年以上临床经验的皮肤科专科医生亲自施术，将疼痛和副作用降至最低。" },
      { question: "在釜山可以在睡眠镇静下进行眼下脂肪重置术吗？", answer: "在釜山西面STAR皮肤科,患者可根据需求在专业医疗人员监督下,以监测镇静方式接受眼下脂肪重置术。镇静治疗前需另行咨询和事前说明,治疗中持续监测生命体征。" },
      { question: "在釜山西面寻找眼下脂肪重置术经验丰富的医院。", answer: "位于釜山广域市釜山镇区西面路74号Ion City大厦4楼的STAR皮肤科,是拥有20年以上临床经验的皮肤科专科医生亲自施术的釜山西面眼下脂肪重置术专科医院。距离釜山地铁西面站步行5分钟。" },
    ],
  },
};
