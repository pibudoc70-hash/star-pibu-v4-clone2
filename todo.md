...
## 성능 최적화: 이미지 지연 로딩(Lazy Loading) 적용
- [x] 이미지 사용 현황 전체 파악 (OptimizedImage 컴포넌트 + 직접 img 태그)
- [x] LCP/eager 유지 대상 확인 (HeroSection 배경/로고, StarLogo, ContactSection 지도, regen-medicine-banner)
- [x] DoctorDesktopLayout.tsx - derm-specialist-badge에 loading="lazy" + decoding="async" 추가
- [x] DoctorMobileLayout.tsx - derm-specialist-badge에 loading="lazy" + decoding="async" 추가
- [x] NonCoveredGuide.tsx - 비급여 가격표 이미지에 loading="lazy" + decoding="async" 추가
- [x] AdminEquipment3.tsx - 썸네일 img 2개에 loading="lazy" + decoding="async" 추가
- [x] AdminEquipment3Edit.tsx - 미리보기 img 4개에 loading="lazy" + decoding="async" 추가
- [x] AdminEquipment3New.tsx - 미리보기 img 3개에 loading="lazy" + decoding="async" 추가
- [x] TypeScript 오류 없음 확인
