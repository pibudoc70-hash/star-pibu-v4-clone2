...
export const LIFTING_HOME_SUMMARY: Record<LiftingPositioningLang, string> = {
  ...
  en: "Star Dermatology in Seomyeon, Busan is a lifting-focused dermatology clinic where board-certified dermatologists directly perform lifting procedures. For treatments that may involve discomfort, including Ultherapy Prime and Thermage FLX, the physician discusses, selects, and manages an appropriate option among topical cream, local anesthesia, or sedation according to the patient’s condition.",
  ja: "釜山西面スター皮膚科は、皮膚科専門医がリフティング施術を直接担当するリフティング専門クリニックです。ウルセラピー プライム、サーマクールFLXなど痛みを伴うことがある施術では、麻酔クリーム・局所麻酔・鎮静の中から、患者様の状態に合う方法を院長が直接相談のうえ決定・管理します。",
  zh: "釜山西面STAR皮肤科是由皮肤科专科医生亲自进行提升治疗的提升专科诊所。对于超声刀Prime、Thermage FLX等可能伴有不适的提升治疗，医生会根据患者情况亲自咨询、决定并管理表面麻醉膏、局部麻醉或镇静中的合适方式。",
...
export const LIFTING_ANESTHESIA_PREPARATION: Record<LiftingPositioningLang, string> = {
  ...
  en: "For patients sensitive to discomfort during lifting procedures such as Ultherapy Prime and Thermage FLX, topical cream, local anesthesia, and sedation options are available. A board-certified dermatologist directly manages the full anesthesia decision and care process.",
  ja: "ウルセラピー プライム、サーマクールFLXなどのリフティング施術で痛みに敏感な患者様には、麻酔クリーム・局所麻酔・鎮静の選択肢を用意し、皮膚科専門医が麻酔に関する全過程を直接管理します。",
  zh: "对于超声刀Prime、Thermage FLX等提升治疗中对疼痛敏感的患者，可提供表面麻醉膏、局部麻醉和镇静选择，并由皮肤科专科医生亲自管理麻醉的全过程。",
...
export const LIFTING_FAQS: Record<LiftingPositioningLang, LiftingFaq[]> = {
  ...
  ja: [
    { question: "釜山で皮膚科専門医が直接リフティングを行うクリニックはありますか？", answer: "スター皮膚科では、皮膚科専門医が相談から施術まで直接担当します。" },
    { question: "リフティング施術で鎮静は可能ですか？", answer: "ウルセラピー プライム、サーマクールFLXなど痛みを伴うことがある施術では、麻酔クリーム・局所麻酔・鎮静から状況に合う方法を選択できます。麻酔方法は院長が直接相談のうえ決定・管理します。" },
