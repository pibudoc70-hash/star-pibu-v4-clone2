...
const TREATMENTS: Record<string, Treatment[]> = {
  ...
  best: [
    {
      ...
      nameJa: "ウルセラ+サーマジリフティング + リジュラン",
      nameZh: "超声刀+热玛吉提升 + 婴儿针",
      cardBannerImage: "/api/storage/ulthermage_17bc44ff_6e5b2994.png",
      ...
      time: "90~120분", timeEn: "90~120min", timeJa: "90~120分", timeZh: "90~120分钟", recovery: "당일 일상", recoveryEn: "Same day", recoveryJa: "当日", recoveryZh: "当天",
      badge: "진정하 시술", badgeEn: "Under Sedation", badgeJa: "鎮静下施術", badgeZh: "镇静麻醉", badgeColor: "#4A6FA5",
      image: "/api/storage/ulthera-prime_1_0daba485_b78e0b48.png",
      images: [
        "/api/storage/ulthera-prime_1_0daba485_b78e0b48.png",
        "/api/storage/thermage-flx_20a90462_e6b7cf77.png",
      ],
      best: true,
    ...
    },
    {
      ...
      nameJa: "プロファウンド RF リフティング",
      nameZh: "PROFOUND RF提升",
      cardBannerImage: "/api/storage/profound_22222541_5e9abf23.png",
      ...
      time: "60~90분", timeEn: "60~90min", timeJa: "60~90分", timeZh: "60~90分钟", recovery: "10일~2주", recoveryEn: "10 days–2 weeks", recoveryJa: "10日〜2週間", recoveryZh: "10天~2周",
      badge: "고효과 리프팅", badgeEn: "High-Efficacy Lifting", badgeJa: "高効果リフティング", badgeZh: "高效提升", badgeColor: "#4A6FA5",
      image: "/api/storage/profound_93be7410_e56130d4.png", best: true,
    ...
    },
    {
      ...
      nameJa: "ボリュームアッププログラム · スカルプトラ",
      nameZh: "充盈提升项目 · 少少针",
      cardBannerImage: "/api/storage/volume_up_3442a94f_0c246218.png",
      ...
      time: "30~60분", timeEn: "30~60min", timeJa: "30~60分", timeZh: "30~60分钟", recovery: "당일 일상", recoveryEn: "Same day", recoveryJa: "当日", recoveryZh: "当天",
      badge: "2년 지속", badgeEn: "2-Year Effect", badgeJa: "2年持続", badgeZh: "效果持续2年", badgeColor: "#9C5FA5",
      image: "/api/storage/treat-sculptra_c3f4b5f6_d019e373.png", best: true,
    ...
    },
    {
      ...
      nameJa: "幹細胞治療",
      nameZh: "干细胞治疗",
      cardBannerImage: "/api/storage/stemcell_ff39fa9f_51689808.png",
      ...
      time: "60~120분", timeEn: "60~120min", timeJa: "60~120分", timeZh: "60~120分钟", recovery: "3~7일", recoveryEn: "3–7 days", recoveryJa: "3〜7日", recoveryZh: "3~7天",
      badge: "자가세포", badgeEn: "Autologous Cells", badgeJa: "自家細胞", badgeZh: "自体细胞", badgeColor: "#2E7D32",
      image: "/api/storage/stemcell_treatment_card-oGb7XJiuyUVsc7VGWNioEw_639b06c3.webp", best: true,
      ...
      modalImage: "/api/storage/stemcell_ff39fa9f_51689808.png",
    },
    {
      name: "흉터 치료 프로그램",
      ...
      nameJa: "瘢痕治療プログラム",
      nameZh: "瘢痕治疗项目",
      cardBannerImage: "/api/storage/scar_d89a476f_b2472d09.png",
      ...
      time: "60~90분", timeEn: "60~90min", timeJa: "60~90分", timeZh: "60~90分钟", recovery: "5~7일", recoveryEn: "5–7 days", recoveryJa: "5〜7日", recoveryZh: "5~7天",
      badge: "진정하 시술", badgeEn: "Under Sedation", badgeJa: "鎮静下施術", badgeZh: "镇静麻醉", badgeColor: "#81C7C9",
      image: `/api/storage/equip-mcl31-ultrapulse_84704967_12498e99.png`,
      images: [
        `/api/storage/equip-mcl31-ultrapulse_84704967_12498e99.png`,
        `/api/storage/equip-ultrapulse-encore_0c14efd1_22f84aaf.png`,
      ],
      best: true,
    ...
    },
    {
      ...
      nameJa: "紅潮・血管治療プログラム",
      nameZh: "红潮血管治疗项目",
      cardBannerImage: "/api/storage/rosacea_32fd1648_93200552.png",
      ...
      time: "20~40분", timeEn: "20~40min", timeJa: "20~40分", timeZh: "20~40分钟", recovery: "1~2일", recoveryEn: "1–2 days", recoveryJa: "1〜2日", recoveryZh: "1~2天",
      badge: "무상처 치료", badgeEn: "No-Wound Treatment", badgeJa: "無傷治療", badgeZh: "无创治疗", badgeColor: "#E57373",
      image: "/api/storage/excel-v_70001aa7_cc87addc.png",
      images: [
        "/api/storage/excel-v_70001aa7_cc87addc.png",
        "/api/storage/adva-tx_nobg_4efd6f20_22664f13.png",
      ],
      imgBg: "#E0F2FE",
      best: true,
    ...
    },
    {
      ...
      nameJa: "肉子・色素治療プログラム",
      nameZh: "黄褐色素治疗项目",
      cardBannerImage: "/api/storage/gimchi_b14edb2c_b775e119.png",
      ...
      time: "30~50분", timeEn: "30~50min", timeJa: "30~50分", timeZh: "30~50分钟", recovery: "당일 일상", recoveryEn: "Same day", recoveryJa: "当日", recoveryZh: "当天",
      badge: "기미 특화", badgeEn: "Melasma Specialist", badgeJa: "シミ特化", badgeZh: "黄褐斑专治", badgeColor: "#7C3AED",
      image: "/api/storage/excel-v_70001aa7_cc87addc.png",
      images: [
        "/api/storage/excel-v_70001aa7_cc87addc.png",
        "/api/storage/enlighten3_nobg_83723c8a_ce8a75f5.png",
      ],
      best: true,
  ...
  lifting: [
    {
      ...
      cardBannerImage: "/api/storage/sub_03_01_52_3b05391b_0904ccff.jpg",
    ...
    },
    {
      ...
      time: "45~90분", timeEn: "45~90min", timeJa: "45~90分", timeZh: "45~90分钟", recovery: "당일 일상", recoveryEn: "Same day", recoveryJa: "当日", recoveryZh: "当天",
      badge: "자문의", badgeEn: "Advisory MD", badgeJa: "顧問医", badgeZh: "顾问医生", badgeColor: "#9C5FA5",
      image: "/api/storage/thermage-flx_20a90462_e6b7cf77.png", best: true,
      cardBannerImage: "/api/storage/sub_03_01_24_9648a599_bab30527.jpg",
    ...
    },
    {
      ...
      time: "60~90분", timeEn: "60~90min", timeJa: "60~90分", timeZh: "60~90分钟", recovery: "당일 일상", recoveryEn: "Same day", recoveryJa: "当日", recoveryZh: "当天",
      badge: "이벤트", badgeEn: "EVENT", badgeJa: "イベント", badgeZh: "活动", badgeColor: "#E57373",
      image: `/api/storage/equip-xerf-cropped_d21e359e_16d3dcea.png`, best: true,
      cardBannerImage: "/api/storage/cerf_c50de6da_e53e2f25.jpg",
    ...
    },
    {
      ...
      cardBannerImage: "/api/storage/profound_65bb8cdd_9f730b8f.jpg",
    ...
    },
    {
      ...
      time: "40~60분", timeEn: "40~60min", timeJa: "40~60分", timeZh: "40~60分钟", recovery: "당일 일상", recoveryEn: "Same day", recoveryJa: "当日", recoveryZh: "当天",
      image: "/api/storage/11-Photoroom_2cf898c6_bd3b2d27.png",
      cardBannerImage: "/api/storage/sub_03_01_36_d097c102_48ab268e.jpg",
      ...
      modalImage: "/api/storage/tensera-modal_9b5a5348_df172994.png",
    },
    {
      name: "버츄RF",
      nameEn: "VIRTUE RF",
      ...
      time: "40~60분", timeEn: "40~60min", timeJa: "40~60分", timeZh: "40~60分钟", recovery: "3~5일", recoveryEn: "3–5 days", recoveryJa: "3〜5日", recoveryZh: "3~5天",
      image: "/api/storage/virtue-rf_d5248119_b5c31b9d.png",
      cardBannerImage: "/api/storage/sub_03_01_43_f3a4cc84_b3315784.jpg",
    ...
    },
    {
      ...
      cardBannerImage: "/api/storage/sub_03_01_37_964152a8_f85d969f.jpg",
    ...
    },
    {
      ...
      time: "30~60분", timeEn: "30~60min", timeJa: "30~60分", timeZh: "30~60分钟", recovery: "당일 일상", recoveryEn: "Same day", recoveryJa: "当日", recoveryZh: "当天",
      image: "/api/storage/onda-thumbnail_c9eb3dc4_744426a1.png",
      cardBannerImage: "/api/storage/onda-thumbnail_c9eb3dc4_744426a1.png",
    ...
    },
    {
      ...
      nameJa: "テンサーマ",
      nameZh: "10THERMA",
      cardBannerImage: "/api/storage/sub_03_01_40_e5717309_dac5a9cd.jpg",
      ...
      time: "20~40분", timeEn: "20~40min", timeJa: "20~40分", timeZh: "20~40分钟", recovery: "당일 일상", recoveryEn: "Same day", recoveryJa: "当日", recoveryZh: "当天",
    ...
    },
    {
      ...
      nameJa: "BBL スキンタイト",
      nameZh: "BBL SkinTyte",
      cardBannerImage: "/api/storage/skintyte_9db77bf0_fab87b78.png",
      ...
      time: "30~60분", timeEn: "30~60min", timeJa: "30~60分", timeZh: "30~60分钟", recovery: "당일 일상", recoveryEn: "Same day", recoveryJa: "当日", recoveryZh: "当天",
      image: "/api/storage/skintyte_9db77bf0_fab87b78.png",
      ...
      modalImage: "/api/storage/skintyte_9db77bf0_fab87b78.png",
    },
    {
      name: "트리니티 리프토닝",
      ...
      nameJa: "トリニティ リフトニング",
      nameZh: "Trinity提升",
      cardBannerImage: "/api/storage/trinity-thumbnail_b5123a89_ca2404f2.jpg",
      ...
      time: "10분 이내", timeEn: "10min or less", timeJa: "10分 以内", timeZh: "10分钟 以内", recovery: "당일 일상", recoveryEn: "Same day", recoveryJa: "当日", recoveryZh: "当天",
      badge: "NEW", badgeEn: "NEW", badgeJa: "NEW", badgeZh: "NEW", badgeColor: "#7C3AED",
      image: "/api/storage/trinity-thumbnail_b5123a89_ca2404f2.jpg",
  ...
  eye: [
    {
      ...
      nameJa: "目の下の脂肪再配置",
      nameZh: "眼下脂肪重置",
      cardBannerImage: "/api/storage/under_eye_4c0b8a51_a2b86535.png",
      ...
      image: "/api/storage/treat-eyelid-new-6Qge5k6ndWTS5nFXDZSXRF_1bdb9103.webp", best: true,
    ...
    },
    {
      ...
      nameJa: "ランチタイム目の下レーザー",
      nameZh: "午休眼下激光",
      cardBannerImage: "/api/storage/lunch_laser_cf471de8_a3ad0be3.jpg",
      ...
      time: "20~30분", timeEn: "20~30min", timeJa: "20~30分", timeZh: "20~30分钟", recovery: "1~2일", recoveryEn: "1–2 days", recoveryJa: "1〜2日", recoveryZh: "1~2天",
      badge: "간편", badgeEn: "Quick", badgeJa: "簡単", badgeZh: "便捷", badgeColor: "#81C7C9",
      image: "/api/storage/treat-lunchtime-laser-patch_afc9f430_cbb8b870.jpg",
  ...
  rosacea: [
...

    {
      ...
      nameJa: "アドバ TX",
      nameZh: "ADVATX",
      cardBannerImage: "/api/storage/adva_d0a73891_c7c2b063.png",
      youtubeUrl: "https://www.youtube.com/embed/Mt-JsBhZXmA",
      ...
      time: "20~40분", timeEn: "20~40min", timeJa: "20~40分", timeZh: "20~40分钟", recovery: "1~2일", recoveryEn: "1–2 days", recoveryJa: "1〜2日", recoveryZh: "1~2天",
      image: "/api/storage/adva_card_53fcdcea_ab70377b.png",
      imgBg: "#FFFFFF",
...

    {
      ...
      nameJa: "BBL レーザー",
      nameZh: "BBL激光",
      cardBannerImage: "/api/storage/BBL_533a94c4_576e8bde.png",
      ...
      time: "20~40분", timeEn: "20~40min", timeJa: "20~40分", timeZh: "20~40分钟", recovery: "1~2일", recoveryEn: "1–2 days", recoveryJa: "1〜2日", recoveryZh: "1~2天",
      image: "/api/storage/bbl_card_86144b4c_e282d4c4.png",
      imgBg: "#FFFFFF",
...

    {
      ...
      nameJa: "エクセル V+",
      nameZh: "Excel V+",
      cardBannerImage: "/api/storage/excelv_119259b6_45eef735.jpg",
      ...
      time: "20~40분", timeEn: "20~40min", timeJa: "20~40分", timeZh: "20~40分钟", recovery: "1~3일", recoveryEn: "1–3 days", recoveryJa: "1〜3日", recoveryZh: "1~3天",
      badge: "특화", badgeEn: "Specialized", badgeJa: "特化", badgeZh: "专项", badgeColor: "#E57373",
      image: "/api/storage/excel-v_70001aa7_cc87addc.png",
      imgBg: "#E0F2FE",
      best: true,
...

    {
      ...
      nameJa: "ペント 9900",
      nameZh: "Pento 9900",
      cardBannerImage: "/api/storage/sub_03_01_25_36cb2ad0_ffa46b85.jpg",
      modalImage: "/api/storage/sub_03_01_25_36cb2ad0_ffa46b85.jpg",
      ...
      time: "20~40분", timeEn: "20~40min", timeJa: "20~40分", timeZh: "20~40分钟", recovery: "1~3일", recoveryEn: "1–3 days", recoveryJa: "1〜3日", recoveryZh: "1~3天",
      image: "/api/storage/pento1064_card_6653a66e_da75482b.png",
      imgBg: "#FFFFFF",
...

    {
      ...
      nameJa: "ルメニス ワン",
      nameZh: "Lumenis One",
      cardBannerImage: "/api/storage/lumenis_558f8b74_36a59570.png",
      modalImage: "/api/storage/lumenis_558f8b74_36a59570.png",
      ...
      time: "20~40분", timeEn: "20~40min", timeJa: "20~40分", timeZh: "20~40分钟", recovery: "1~3일", recoveryEn: "1–3 days", recoveryJa: "1〜3日", recoveryZh: "1~3天",
      image: "/api/storage/lumenis_v_card_03c774b0_783e37e1.png",
      imgBg: "#FFFFFF",
...

    {
      ...
      nameJa: "シナジー",
      nameZh: "Synergy",
      cardBannerImage: "/api/storage/synergy_e96088b2_8477651e.png",
      modalImage: "/api/storage/synergy_e96088b2_8477651e.png",
      ...
      time: "20~40분", timeEn: "20~40min", timeJa: "20~40分", timeZh: "20~40分钟", recovery: "1~3일", recoveryEn: "1–3 days", recoveryJa: "1〜3日", recoveryZh: "1~3天",
      image: "/api/storage/cynergy_card_1cb99049_c1dfb97b.png",
      imgBg: "#FFFFFF",
  ...
  pigment: [
    {
      ...
      nameJa: "キュアマックス",
      nameZh: "Curemax",
      cardBannerImage: "/api/storage/sub_03_01_53_222a4ae8_1072ebdf.jpg",
      ...
      time: "20~40분", timeEn: "20~40min", timeJa: "20~40分", timeZh: "20~40分钟", recovery: "3~5일", recoveryEn: "3–5 days", recoveryJa: "3〜5日", recoveryZh: "3~5天",
    ...
    },
    {
      ...
      nameJa: "スターウォーカー MAQX",
      nameZh: "StarWalker MAQX",
      cardBannerImage: "/api/storage/starwalker_5dd4eb14_c3efd6e9.jpg",
      ...
      time: "20~30분", timeEn: "20~30min", timeJa: "20~30分", timeZh: "20~30分钟", recovery: "당일 일상", recoveryEn: "Same day", recoveryJa: "当日", recoveryZh: "当天",
      image: "/api/storage/starwalker_b95a35a4_b023c330.png",
      modalImage: "/api/storage/starwalker_5dd4eb14_c3efd6e9.jpg",
    ...
    },
    {
      ...
      nameJa: "インライトン 3世代 ルビーピコ",
      nameZh: "Enlighten III Ruby Pico",
      cardBannerImage: "/api/storage/enlighten_d0c7a409_3b203f6b.jpg",
      ...
      time: "20~40분", timeEn: "20~40min", timeJa: "20~40分", timeZh: "20~40分钟", recovery: "3~5일", recoveryEn: "3–5 days", recoveryJa: "3〜5日", recoveryZh: "3~5天",
      badge: "인기", badgeEn: "Popular", badgeJa: "人気", badgeZh: "热门", badgeColor: "#4A6FA5",
      image: "/api/storage/enlighten3_nobg_83723c8a_ce8a75f5.png", best: true,
      modalImage: "/api/storage/enlighten_d0c7a409_3b203f6b.jpg",
    ...
    },
    {
      ...
      nameJa: "エクセル V+",
      nameZh: "Excel V+",
      cardBannerImage: "/api/storage/pc_sub_03_03_26_caee4454_58d8a425.jpg",
    ...
    },
    {
      ...
      time: "20~40분", timeEn: "20~40min", timeJa: "20~40分", timeZh: "20~40分钟", recovery: "당일~3일", recoveryEn: "Same day–3 days", recoveryJa: "当日〜3日", recoveryZh: "当天~3天",
      image: "/api/storage/bbl_card_86144b4c_e282d4c4.png",
      modalImage: "/api/storage/BBL_533a94c4_576e8bde.png",
      youtubeUrl: "https://www.youtube.com/embed/PbCt12_WYFo",
    ...
    },
    {
      ...
      nameJa: "ルメニス ワン",
      nameZh: "Lumenis One",
      cardBannerImage: "/api/storage/pigment_lumenis_fa549937_f4245a1d.png",
      ...
      time: "20~40분", timeEn: "20~40min", timeJa: "20~40分", timeZh: "20~40分钟", recovery: "당일~3일", recoveryEn: "Same day–3 days", recoveryJa: "当日〜3日", recoveryZh: "当天~3天",
      image: "/api/storage/lumenis-one_558f8b74_b439c8eb.png",
      youtubeUrl: "https://www.youtube.com/embed/rA_n4hbY5Dc",
    ...
    {      name: "펜토 9900",
      ...
      nameJa: "ペント 9900",
      nameZh: "Pento 9900",
      cardBannerImage: "/api/storage/pigment_pento_704d9859_3be444d7.png",
      ...
      modalImage: "/api/storage/pigment_pento_704d9859_3be444d7.png",
    ...
    },
    {
      name: "라셈드 울트라",
      nameEn: "LASEMD ULTRA",
      cardBannerImage: "/api/storage/lasemd_a5fd8612_abef979c.png",
      ...
      time: "20~40분", timeEn: "20~40min", timeJa: "20~40分", timeZh: "20~40分钟", recovery: "1~3일", recoveryEn: "1–3 days", recoveryJa: "1〜3日", recoveryZh: "1~3天",
      badge: "저자극 회복", badgeEn: "Gentle Recovery", badgeJa: "低刺激回復", badgeZh: "温和恢复", badgeColor: "#7C3AED",
      image: "/api/storage/lasemd-ultra_a5fd8612_006e0525.png",
      modalImage: "/api/storage/lasemd_a5fd8612_abef979c.png",
  ...
  scar: [
    {
      ...
      cardBannerImage: "/api/storage/ultrapulse_6857e3b1_b2e1afd7.png",
      ...
      time: "30~60분", timeEn: "30~60min", timeJa: "30~60分", timeZh: "30~60分钟", recovery: "5~7일", recoveryEn: "5–7 days", recoveryJa: "5〜7日", recoveryZh: "5~7天",
      badge: "특화", badgeEn: "Specialized", badgeJa: "特化", badgeZh: "专项", badgeColor: "#4A6FA5",
      image: "/api/storage/ultrapulse_6857e3b1_b2e1afd7.png", best: true,
    ...
    },
    {
      name: "미라젯",
      nameEn: "MIRAJET",
      cardBannerImage: "/api/storage/mirajet_8290d437_e2422a1b.png",
      ...
      time: "20~40분", timeEn: "20~40min", timeJa: "20~40分", timeZh: "20~40分钟", recovery: "1~3일", recoveryEn: "1–3 days", recoveryJa: "1〜3日", recoveryZh: "1~3天",
      image: "/api/storage/mirajet_8290d437_e2422a1b.png",
    ...
    },
    {
      ...
      cardBannerImage: "/api/storage/DRT_0cfd047a_dd0f3170.png",
      ...
      time: "30~60분", timeEn: "30~60min", timeJa: "30~60分", timeZh: "30~60分钟", recovery: "2~5일", recoveryEn: "2–5 days", recoveryJa: "2〜5日", recoveryZh: "2~5天",
      image: "/api/storage/DRT_0cfd047a_dd0f3170.png",
      modalImage: "/api/storage/DRT_0cfd047a_dd0f3170.png",
...

    {
      ...
      nameEn: "TRIFILL PRO",
      youtubeUrl: "https://www.youtube.com/embed/DFB4SZU5U-g",
      cardBannerImage: "/api/storage/sub_03_01_47_81166797_4a36143e.jpg",
    ...
    },
    {
      name: "모래알 피부이식",
      nameEn: "SST PRO",
      cardBannerImage: "/api/storage/sand_skin_b1e8163f_0f982351.png",
    ...
    },
    {
      ...
      cardBannerImage: "/api/storage/joule_pro_f08a640a_d6c20596.png",
      ...
      time: "30~60분", timeEn: "30~60min", timeJa: "30~60分", timeZh: "30~60分钟", recovery: "5~7일", recoveryEn: "5–7 days", recoveryJa: "5〜7日", recoveryZh: "5~7天",
      badge: "모공·흉터 특화", badgeEn: "Pore & Scar Specialist", badgeJa: "毛穴・傷跡特化", badgeZh: "毛孔·疤痕专治", badgeColor: "#065F46",
      image: "/api/storage/joule-fractional-laser_5152ce2e_eb35b3ea.jpg",
    ...
    },
    {
      name: "쥴 헤일로",
      nameEn: "JOULE HALO",
      cardBannerImage: "/api/storage/halo_joule_d88c347b_46650c62.png",
      ...
      time: "30~60분", timeEn: "30~60min", timeJa: "30~60分", timeZh: "30~60分钟", recovery: "5~7일", recoveryEn: "5–7 days", recoveryJa: "5〜7日", recoveryZh: "5~7天",
      badge: "Halo Glow", badgeEn: "Halo Glow", badgeJa: "Halo Glow", badgeZh: "Halo Glow", badgeColor: "#047857",
      image: "/api/storage/halo-hybrid-laser_bf04f00b_aed72664.jpeg",
  ...
  volume: [
    {
      name: "스킨부스터",
      nameEn: "SKIN BOOSTER",
      cardBannerImage: "/api/storage/skinbooster_4529f8dc_e5414109.png",
      modalImage: "/api/storage/skinbooster_4529f8dc_e5414109.png",
      ...
      time: "20~40분", timeEn: "20~40min", timeJa: "20~40分", timeZh: "20~40分钟", recovery: "당일 일상", recoveryEn: "Same day", recoveryJa: "当日", recoveryZh: "当天",
      badge: "인기", badgeEn: "Popular", badgeJa: "人気", badgeZh: "热门", badgeColor: "#81C7C9",
      image: "/api/storage/7IUeNj7YG383_91ad3b5b_b961c93e.jpg", best: true,
    ...
    },
    {
      ...
      cardBannerImage: "/api/storage/stemcell2_9034d023_37debf2a.png",
      modalImage: "/api/storage/stemcell2_9034d023_37debf2a.png",
      ...
      time: "60~120분", timeEn: "60~120min", timeJa: "60~120分", timeZh: "60~120分钟", recovery: "3~7일", recoveryEn: "3–7 days", recoveryJa: "3〜7日", recoveryZh: "3~7天",
      badge: "프리미엄", badgeEn: "Premium", badgeJa: "プレミアム", badgeZh: "高端", badgeColor: "#9C5FA5",
      image: "/api/storage/stemcell_9034d023_69e8c03e.png",
    ...
    },
    {
      ...
      cardBannerImage: "/api/storage/collagen_2fb56379_2b5ce7a6.png",
      modalImage: "/api/storage/collagen_2fb56379_2b5ce7a6.png",
      ...
      time: "20~30분", timeEn: "20~30min", timeJa: "20~30分", timeZh: "20~30分钟", recovery: "1~3일", recoveryEn: "1–3 days", recoveryJa: "1〜3日", recoveryZh: "1~3天",
      image: "/api/storage/enerjet_afcf856d_370d2a25.png",
    ...
    },
    {
      name: "엑소좀",
      nameEn: "ASCE+",
      cardBannerImage: "/api/storage/exosome_6eeb4268_0832454d.png",
      modalImage: "/api/storage/exosome_6eeb4268_0832454d.png",
      ...
      time: "30~60분", timeEn: "30~60min", timeJa: "30~60分", timeZh: "30~60分钟", recovery: "당일 일상", recoveryEn: "Same day", recoveryJa: "当日", recoveryZh: "当天",
      image: "/api/storage/exosome_treatment_card-FL5KNDXVdmJCtUV4DFoGSD_a03acdf5.webp",
    ...
    },
    {
      ...
      cardBannerImage: "/api/storage/juvelook_vol_d9ad38c6_445907dd.png",
      modalImage: "/api/storage/juvelook_vol_d9ad38c6_445907dd.png",
      ...
      time: "20~40분", timeEn: "20~40min", timeJa: "20~40分", timeZh: "20~40分钟", recovery: "1~3일", recoveryEn: "1–3 days", recoveryJa: "1〜3日", recoveryZh: "1~3天",
      badge: "복합 효과", badgeEn: "Multi-Effect", badgeJa: "複合効果", badgeZh: "复合效果", badgeColor: "#B45309",
      image: "/api/storage/7IUeNj7YG383_91ad3b5b_b961c93e.jpg",
    ...
    },
    {
      name: "리투오",
      nameEn: "RE20",
      cardBannerImage: "/api/storage/lituo_17dec4a1_9318c9a5.png",
      modalImage: "/api/storage/lituo_17dec4a1_9318c9a5.png",
      ...
      time: "20~30분", timeEn: "20~30min", timeJa: "20~30分", timeZh: "20~30分钟", recovery: "1~2일", recoveryEn: "1–2 days", recoveryJa: "1〜2日", recoveryZh: "1~2天",
      badge: "수분·재생", badgeEn: "Hydration & Regen", badgeJa: "水分・再生", badgeZh: "补水·再生", badgeColor: "#A16207",
      image: "/api/storage/lituo_17dec4a1_9318c9a5.png",
  ...
  botox: [
    {
      name: "보톡스",
      nameEn: "BOTOX",
      cardBannerImage: "/api/storage/botox_552ff42a_122f21fa.png",
      ...
      time: "10~20분", timeEn: "10~20min", timeJa: "10~20分", timeZh: "10~20分钟", recovery: "당일 일상 복귀", recoveryEn: "Same day", recoveryJa: "当日復帰", recoveryZh: "当天恢复",
      badge: "주름 개선", badgeEn: "Wrinkle Correction", badgeJa: "しわ改善", badgeZh: "改善皱纹", badgeColor: "#D97706",
      image: "/api/storage/botox_552ff42a_fa3d41b2.png",
    ...
    },
    {
      name: "필러",
      nameEn: "FILLER",
      cardBannerImage: "/api/storage/filler_79748c4a_f3ba72e1.png",
      ...
      time: "20~30분", timeEn: "20~30min", timeJa: "20~30分", timeZh: "20~30分钟", recovery: "당일 일상 복귀", recoveryEn: "Same day", recoveryJa: "当日復帰", recoveryZh: "当天恢复",
      badge: "볼륨 개선", badgeEn: "Volume Enhancement", badgeJa: "ボリューム改善", badgeZh: "丰盈改善", badgeColor: "#EC4899",
      image: "/api/storage/filler_79748c4a_221edb80.png",
    ...
    },
    {
      ...
      cardBannerImage: "/api/storage/sub_03_01_49_354098fb_02f74850.jpg",
      ...
      time: "20~30분", timeEn: "20~30min", timeJa: "20~30分", timeZh: "20~30分钟", recovery: "1~3일", recoveryEn: "1–3 days", recoveryJa: "1〜3日", recoveryZh: "1~3天",
      image: "/api/storage/0dVRx3DuVpWY_30a10709_17715098.jpg",
    ...
    },
    {
      ...
      cardBannerImage: "/api/storage/rejuran_98677b53_95ee5168.png",
      ...
      time: "20~40분", timeEn: "20~40min", timeJa: "20~40分", timeZh: "20~40分钟", recovery: "1~3일", recoveryEn: "1–3 days", recoveryJa: "1〜3日", recoveryZh: "1~3天",
      image: "/api/storage/rejuran_98677b53_95ee5168.png",
    ...
    },
    {
      ...
      cardBannerImage: "/api/storage/healer_plus_9a47b1bf_54983660.png",
      ...
      time: "20~40분", timeEn: "20~40min", timeJa: "20~40分", timeZh: "20~40分钟", recovery: "1~2일", recoveryEn: "1–2 days", recoveryJa: "1〜2日", recoveryZh: "1~2天",
      badge: "재생·수분", badgeEn: "Regen & Hydration", badgeJa: "再生・水分", badgeZh: "再生·补水", badgeColor: "#4A6FA5",
      image: "/api/storage/healer_plus_9a47b1bf_54983660.png",
    ...
    },
    {
      ...
      cardBannerImage: "/api/storage/juvelook_f03b1652_19070c86.png",
      ...
      time: "20~30분", timeEn: "20~30min", timeJa: "20~30分", timeZh: "20~30分钟", recovery: "당일 일상", recoveryEn: "Same day", recoveryJa: "当日", recoveryZh: "当天",
      badge: "수분·탄력", badgeEn: "Hydration & Elasticity", badgeJa: "水分・弾力", badgeZh: "补水·弹力", badgeColor: "#0C4A6E",
      image: "/api/storage/IkzStH3azHFL_d72284cb_0b6299ad.webp",
  ...
  acne_laser: [
    {
      name: "아비클리어",
      nameEn: "AVICLEAR",
      cardBannerImage: "/api/storage/sub_03_01_51_8ba2c238_78fd4060.jpg",
      ...
      time: "30분", timeEn: "30min", timeJa: "30分", timeZh: "30分钟", recovery: "1~3일", recoveryEn: "1–3 days", recoveryJa: "1〜3日", recoveryZh: "1~3天",
      badge: "FDA 승인", badgeEn: "FDA Approved", badgeJa: "FDA承認", badgeZh: "FDA认证", badgeColor: "#E57373",
      image: "/api/storage/aviclear_3d94823e_d47688ce.png", best: true,
    ...
    },
    {
      name: "카프리",
      nameEn: "CAPRI",
      cardBannerImage: "/api/storage/sub_03_01_17_6d79640f_d0039272.jpg",
      ...
      time: "20~30분", timeEn: "20~30min", timeJa: "20~30分", timeZh: "20~30分钟", recovery: "1~2일", recoveryEn: "1–2 days", recoveryJa: "1〜2日", recoveryZh: "1~2天",
      badge: "염증 억제", badgeEn: "Anti-Inflammatory", badgeJa: "炎症抑制", badgeZh: "消炎", badgeColor: "#C2410C",
      image: "/api/storage/gKokBoh3bDWm_b8ea202e_b642b1d1.jpg",
    ...
    },
    {
      name: "플라듀오",
      nameEn: "PLADUO",
      cardBannerImage: "/api/storage/sub_03_01_23_5c9552c8_5be5a89a.png",
      ...
      time: "20~30분", timeEn: "20~30min", timeJa: "20~30分", timeZh: "20~30分钟", recovery: "1~2일", recoveryEn: "1–2 days", recoveryJa: "1〜2日", recoveryZh: "1~2天",
      badge: "복합 치료", badgeEn: "Combination Therapy", badgeJa: "複合治療", badgeZh: "复合治疗", badgeColor: "#9A3412",
      image: "/api/storage/RypUEm7gjHfk_0760fc35_111faf83.png",
      modalImage: "/api/storage/pasted_file_4a6a6715_1a9a95db.png",
      youtubeUrl: "https://www.youtube.com/embed/e3vB44VsoW4",
    ...
    },
    {
      ...
      cardBannerImage: "/api/storage/platinum_eecfc2a9_a30aa36f.jpg",
      ...
      time: "30~40분", timeEn: "30~40min", timeJa: "30~40分", timeZh: "30~40分钟", recovery: "1~2일", recoveryEn: "1–2 days", recoveryJa: "1〜2日", recoveryZh: "1~2天",
      badge: "박테리아 파괴", badgeEn: "Bacteria Elimination", badgeJa: "細菌破壊", badgeZh: "消灭细菌", badgeColor: "#7C3AED",
      image: "/api/storage/platinum_eecfc2a9_a30aa36f.jpg",
      modalImage: "/api/storage/platinum_eecfc2a9_a30aa36f.jpg",
    ...
    {      name: "네오젠 플라즈마",
      ...
      cardBannerImage: "/api/storage/neogen_3d1a87bc_b475f9ab.jpg",
      ...
      time: "30~50분", timeEn: "30~50min", timeJa: "30~50分", timeZh: "30~50分钟", recovery: "3~7일", recoveryEn: "3–7 days", recoveryJa: "3〜7日", recoveryZh: "3~7天",
      badge: "피부 재생", badgeEn: "Skin Regeneration", badgeJa: "皮膚再生", badgeZh: "皮肤再生", badgeColor: "#0F766E",
      image: "/api/storage/YgF34hnTbXog_e46e8323_fc2a8c2d.png",
      modalImage: "/api/storage/neogen_3d1a87bc_b475f9ab.jpg",
    ...
    },
    {
      name: "고바야시 절연침",
      nameEn: "AGNES",
      cardBannerImage: "/api/storage/kobayashi_600a1edd_fdc5f035.png",
      ...
      time: "30~40분", timeEn: "30~40min", timeJa: "30~40分", timeZh: "30~40分钟", recovery: "1~2일", recoveryEn: "1–2 days", recoveryJa: "1〜2日", recoveryZh: "1~2天",
      badge: "절연침 기술", badgeEn: "Insulated Needle", badgeJa: "絶縁針技術", badgeZh: "绝缘针技术", badgeColor: "#2563EB",
      image: "/api/storage/kobayashi_600a1edd_fdc5f035.png",
      modalImage: "/api/storage/kobayashi_600a1edd_fdc5f035.png",
  ...
  acne: [
    {
      ...
      cardBannerImage: "/api/storage/sub_03_01_29_56ec9c83_33a96223.jpg",
      ...
      time: "60~90분", timeEn: "60~90min", timeJa: "60~90分", timeZh: "60~90分钟", recovery: "3~5일", recoveryEn: "3–5 days", recoveryJa: "3〜5日", recoveryZh: "3~5天",
      badge: "영구 제거", badgeEn: "Permanent Removal", badgeJa: "永久除去", badgeZh: "永久去除", badgeColor: "#0F766E",
      image: "/api/storage/HEkn0mzQWyoC_4d1c0020_344c469f.jpeg",
    ...
    },
    {
      name: "리포셋",
      nameEn: "LIPOSAT",
      cardBannerImage: "/api/storage/liposet_f24523db_cfc6ed5f.png",
      ...
      time: "40~60분", timeEn: "40~60min", timeJa: "40~60分", timeZh: "40~60分钟", recovery: "2~3일", recoveryEn: "2–3 days", recoveryJa: "2〜3日", recoveryZh: "2~3天",
      badge: "지방+땀샘 동시", badgeEn: "Fat+Gland Dual", badgeJa: "脂肪+汗腺同時", badgeZh: "脂肪+汗腺同时", badgeColor: "#7C3AED",
      image: "/api/storage/liposet_f24523db_cfc6ed5f.png",
      modalImage: "/api/storage/liposet_f24523db_cfc6ed5f.png",
    ...
    },
    {
      ...
      cardBannerImage: "/api/storage/hyperhidrosis_bd731d90_bf6390be.png",
      ...
      time: "20~30분", timeEn: "20~30min", timeJa: "20~30分", timeZh: "20~30分钟", recovery: "당일 일상 복귀", recoveryEn: "Same day", recoveryJa: "当日復帰", recoveryZh: "当天恢复",
      badge: "당일 복귀", badgeEn: "Same-Day Return", badgeJa: "当日復帰", badgeZh: "当天恢复", badgeColor: "#0369A1",
      image: "/api/storage/hyperhidrosis_bd731d90_bf6390be.png",
      modalImage: "/api/storage/hyperhidrosis_bd731d90_bf6390be.png",
  ...
  fungus: [    {      name: "핀포인트",
      nameEn: "PINPOINTE",
      cardBannerImage: "/api/storage/pinpoint_d7892fbb_3ffa6c7a.png",
      ...
      time: "15~20분", timeEn: "15~20min", timeJa: "15~20分", timeZh: "15~20分钟", recovery: "당일 일상", recoveryEn: "Same day", recoveryJa: "当日", recoveryZh: "当天",
      badge: "FDA 승인", badgeEn: "FDA Approved", badgeJa: "FDA承認", badgeZh: "FDA认证", badgeColor: "#0F766E",
      image: "/api/storage/pinpoint_d7892fbb_3ffa6c7a.png",
      modalImage: "/api/storage/pinpoint_d7892fbb_3ffa6c7a.png",
    ...
    },
    {
      name: "힐러 1064",
      nameEn: "HEALER 1064",
      cardBannerImage: "/api/storage/healer_fb0f59c9_1971cf8d.jpg",
      ...
      time: "20~30분", timeEn: "20~30min", timeJa: "20~30分", timeZh: "20~30分钟", recovery: "당일 일상", recoveryEn: "Same day", recoveryJa: "当日", recoveryZh: "当天",
      badge: "레이저 치료", badgeEn: "Laser Treatment", badgeJa: "レーザー治療", badgeZh: "激光治疗", badgeColor: "#0F766E",
      image: "/api/storage/healer_fb0f59c9_1971cf8d.jpg",
      modalImage: "/api/storage/healer_fb0f59c9_1971cf8d.jpg",
    ...
    },
    {
      name: "오니코",
      nameEn: "ONYCHO",
      cardBannerImage: "/api/storage/onico_e7c50add_f9959bfc.jpg",
      ...
      time: "15~25분", timeEn: "15~25min", timeJa: "15~25分", timeZh: "15~25分钟", recovery: "당일 일상", recoveryEn: "Same day", recoveryJa: "当日", recoveryZh: "当天",
      badge: "식약처 허가", badgeEn: "MFDS Approved", badgeJa: "食薬処許可", badgeZh: "食药处批准", badgeColor: "#0369A1",
      image: "/api/storage/onico_e7c50add_f9959bfc.jpg",
      modalImage: "/api/storage/onico_e7c50add_f9959bfc.jpg",
    ...
    },
    {
      name: "엑셀 토우",
      nameEn: "EXCEL TOE",
      cardBannerImage: "/api/storage/exceltoe_ddf531cd_640524bb.png",
      ...
      image: "/api/storage/exceltoe_ddf531cd_640524bb.png",
      modalImage: "/api/storage/exceltoe_ddf531cd_640524bb.png",
  ...
  vitiligo: [
    ...
    },
    {
      ...
      badge: "백반증 전문",
      badgeColor: "#4A6FA5",
      cardBannerImage: "/api/storage/excimer_3b91923d_3e298b36.png",
    ...
    },
    {
      ...
      badge: "전신 치료",
      badgeColor: "#4A6FA5",
      cardBannerImage: "/api/storage/uv_therapy_0b66082d_1caf8012.png",
      ...
      time: "5~15분", timeEn: "5~15min", timeJa: "5~15分", timeZh: "5~15分钟", recovery: "당일 일상", recoveryEn: "Same day", recoveryJa: "当日", recoveryZh: "当天",
      image: "/api/storage/3PticSr0g4jr_e69d1049_93cf9008.jpg",
  ...
  psoriasis: [
    {
      ...
      badgeColor: "#4A6FA5",
      cardBannerImage: "/api/storage/uv_therapy_0b66082d_1caf8012.png",
      modalImage: "/api/storage/uv_therapy_0b66082d_1caf8012.png",
    ...
    },
    {
      ...
      cardBannerImage: "/api/storage/atopy_303bd029_072c10e9.png",
      modalImage: "/api/storage/atopy_303bd029_072c10e9.png",
      badge: "복합 치료",
  ...
  stem_cell: [
    {
      name: "혈액줄기세포",
      nameEn: "BLOOD STEM CELL",
      nameJa: "血液幹細胞",
      nameZh: "血液干细胞",
      cardBannerImage: "/api/storage/stemcell_ff39fa9f_51689808.png",
      modalImage: "/api/storage/stemcell_ff39fa9f_51689808.png",
      desc: "소량의 혈액에서 줄기세포를 분리·농축하여 피부에 직접 주사하는 자가세포 치료.\n채혈만으로 준비되어 시술 과정이 간편하고 이상반응 위험이 낮습니다.",
      descEn: "Autologous cell therapy that separates and concentrates stem cells from a small blood sample and injects them directly into the skin. Simple preparation with just a blood draw and low risk of adverse reactions.",
      descJa: "少量の血液から幹細胞を分離・濃縮して皮膚に直接注射する自家細胞治療。採血だけで準備でき、施術過程が簡単で異常反応リスクが低いです。",
      descZh: "从少量血液中分离浓缩干细胞并直接注射到皮肤的自体细胞疗法。仅需采血即可准备，操作简便，不良反应风险低。",
      time: "60~90분", timeEn: "60~90min", timeJa: "60~90分", timeZh: "60~90分钟", recovery: "1~3일", recoveryEn: "1–3 days", recoveryJa: "1〜3日", recoveryZh: "1~3天",
      badge: "자가세포", badgeEn: "Autologous Cells", badgeJa: "自家細胞", badgeZh: "自体细胞", badgeColor: "#2E7D32",
      image: "/api/storage/stemcell_treatment_card-oGb7XJiuyUVsc7VGWNioEw_639b06c3.webp",
      ...
      detailEn: "Blood-derived stem cell therapy involves drawing a small amount of blood (approximately 20-30ml) and concentrating/separating stem cell components through centrifugation. The separated stem cells are precisely injected into areas of skin aging to directly supply skin regeneration factors. Since cells extracted from your own blood are used, the risk of adverse reactions and rejection is low, and it improves skin elasticity, hydration, and texture. Short recovery period allows quick return to daily activities.",
      detailJa: "血液由来幹細胞治療は少量の血液（約20〜30ml）を採取し、遠心分離過程を通じて幹細胞成分を濃縮・分離します。分離された幹細胞を皮膚老化が進行した部位に精密に注射して皮膚再生因子を直接供給します。自分の血液から抽出した細胞を使用するため異常反応・拒絶反応リスクが低く、皮膚の弾力・水分・肌質改善を誘導します。施術後の回復期間が短く、日常生活への復帰が早いです。",
      detailZh: "血液源干细胞治疗是抽取少量血液（约20-30ml），通过离心分离过程浓缩提取干细胞成分。将分离的干细胞精准注射到皮肤老化部位，直接提供皮肤再生因子。由于使用从自身血液中提取的细胞，不良反应和排斥反应风险低，改善皮肤弹力、水分和质感。术后恢复期短，可快速恢复日常活动。",
      caution: "시술 전 채혈 과정이 포함됩니다. 시술 후 1~3일간 주사 부위에 경미한 붓기·멍이 나타날 수 있습니다. 시술 후 1주일간 격렬한 운동과 음주는 피하세요. 효과는 개인차가 있으며 담당 의료진과 충분히 상담 후 결정하세요.",
      sessions: "1~3회 (담당 의료진 상담 후 결정)",
      sessionsEn: "1–3 sessions (determined after consultation with attending physician)",
      sessionsJa: "1〜3回（担当医師との相談後に決定）",
      sessionsZh: "1~3次（与主治医生咨询后决定）",
    ...
    {
      name: "지방줄기세포",
      nameEn: "FAT STEM CELL",
      nameJa: "脂肪幹細胞",
      nameZh: "脂肪干细胞",
      cardBannerImage: "/api/storage/stemcell2_9034d023_37debf2a.png",
      modalImage: "/api/storage/stemcell2_9034d023_37debf2a.png",
      desc: "복부·허벅지 등 지방 조직에서 추출한 줄기세포를 피부에 주사하는 자가세포 치료.\n혈액 유래 대비 더 많은 줄기세포를 확보할 수 있어 효과가 풍부합니다.",
      descEn: "Autologous cell therapy that injects stem cells extracted from adipose tissue (abdomen, thighs) into the skin. More stem cells can be obtained compared to blood-derived therapy for richer effects.",
      descJa: "腹部・太ももなどの脂肪組織から抽出した幹細胞を皮膚に注射する自家細胞治療。血液由来と比べてより多くの幹細胞を確保でき、効果が豊富です。",
      descZh: "将从腹部、大腿等脂肪组织中提取的干细胞注射到皮肤的自体细胞疗法。与血液源相比可获得更多干细胞，效果更为丰富。",
      time: "90~120분", timeEn: "90~120min", timeJa: "90~120分", timeZh: "90~120分钟", recovery: "3~7일", recoveryEn: "3–7 days", recoveryJa: "3〜7日", recoveryZh: "3~7天",
      badge: "프리미엄", badgeEn: "Premium", badgeJa: "プレミアム", badgeZh: "高端", badgeColor: "#9C5FA5",
      image: "/api/storage/stemcell_9034d023_69e8c03e.png",
      detail: "지방 유래 줄기세포 치료는 복부·허벅지 등에서 소량의 지방(약 50~100ml)을 채취하여 줄기세포를 분리·농축합니다. 지방 조직은 혈액 대비 훨씬 많은 줄기세포를 함유하고 있어 더 풍부한 재생 인자를 피부에 공급할 수 있습니다. 분리된 줄기세포를 피부 노화 부위에 정밀하게 주사하여 콜라겐 생성을 촉진하고 피부 재생을 유도합니다. 자신의 세포를 사용하므로 이상반응 위험이 낮으며, 효과 지속 기간이 길어 프리미엄 안티에이징 치료로 선택됩니다.",
      detailEn: "Fat-derived stem cell therapy involves extracting a small amount of fat (approximately 50-100ml) from the abdomen or thighs and separating/concentrating stem cells. Adipose tissue contains far more stem cells than blood, allowing richer regenerative factors to be supplied to the skin. The separated stem cells are precisely injected into aging skin areas to stimulate collagen production and induce skin regeneration. Since your own cells are used, the risk of adverse reactions is low, and the long-lasting effect makes it a premium anti-aging treatment.",
      detailJa: "脂肪由来幹細胞治療は腹部・太ももなどから少量の脂肪（約50〜100ml）を採取して幹細胞を分離・濃縮します。脂肪組織は血液と比べてはるかに多くの幹細胞を含んでおり、より豊富な再生因子を皮膚に供給できます。分離された幹細胞を皮膚老化部位に精密に注射してコラーゲン生成を促進し皮膚再生を誘導します。自分の細胞を使用するため異常反応リスクが低く、効果持続期間が長いためプレミアムアンチエイジング治療として選ばれます。",
      detailZh: "脂肪源干细胞治疗是从腹部、大腿等部位提取少量脂肪（约50-100ml），分离浓缩干细胞。脂肪组织含有比血液多得多的干细胞，可以向皮肤提供更丰富的再生因子。将分离的干细胞精准注射到皮肤老化部位，促进胶原蛋白生成并诱导皮肤再生。由于使用自身细胞，不良反应风险低，效果持续时间长，被选为高端抗衰老治疗。",
      caution: "시술 전 지방 채취 과정이 포함됩니다(소량 지방흡입). 시술 후 3~7일간 채취 부위 및 주사 부위에 붓기·멍이 나타날 수 있습니다. 시술 후 1주일간 격렬한 운동과 음주는 피하세요. 효과는 개인차가 있으며 담당 의료진과 충분히 상담 후 결정하세요.",
      sessions: "1~2회 (담당 의료진 상담 후 결정)",
      sessionsEn: "1–2 sessions (determined after consultation with attending physician)",
      sessionsJa: "1〜2回（担当医師との相談後に決定）",
      sessionsZh: "1~2次（与主治医生咨询后决定）",
      effect: "피부 세포 재생, 콜라겐 생성 촉진, 탄력 회복, 주름 개선, 피부 톤 균일화",
      effectEn: "Skin cell regeneration, collagen production stimulation, elasticity recovery, wrinkle improvement, skin tone evenness",
      effectJa: "皮膚細胞再生、コラーゲン生成促進、弾力回復、しわ改善、皮膚トーン均一化",
      effectZh: "皮肤细胞再生、促进胶原蛋白生成、弹力恢复、改善皱纹、肤色均匀化",
    },
  ],
};
