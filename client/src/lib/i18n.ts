...
export const i18n: Record<Lang, I18nContent> = {
  ko: {
    ...
    reviews: {
      ...
      nextLabel: "다음",
      items: [
        { name: "김민지", age: "32세", treatment: "눈밑지방재배치", text: "다크서클이 정말 심했는데 시술 후 한 달 만에 눈이 확 밝아졌어요. 자연스럽고 만족합니다!", platform: "Naver", rating: 5, date: "2024-01-15" },
        { name: "이수진", age: "28세", treatment: "피코레이저", text: "기미가 많았는데 3회 시술로 정말 많이 개선됐어요. 피부톤도 밝아지고 만족합니다.", platform: "Naver", rating: 5, date: "2024-01-10" },
        { name: "박지은", age: "35세", treatment: "울쎄라피 프라임", text: "리프팅 효과가 정말 좋습니다. 자연스럽고 회복 기간도 짧아서 좋아요.", platform: "Naver", rating: 5, date: "2024-01-05" },
      ],
    },
    facility: {
      sectionTitle: "시설 안내",
  ...
  en: {
    ...
    reviews: {
      ...
      nextLabel: "Next",
      items: [
        { name: "Min-ji Kim", age: "32", treatment: "Under-Eye Fat Repositioning", text: "My dark circles were severe, but after the procedure, my eyes brightened within a month. Very natural and satisfied!", platform: "Naver", rating: 5, date: "2024-01-15" },
        { name: "Su-jin Lee", age: "28", treatment: "Pico Laser", text: "I had many age spots, and after 3 sessions they improved significantly. My skin tone is also brighter now.", platform: "Naver", rating: 5, date: "2024-01-10" },
        { name: "Ji-eun Park", age: "35", treatment: "Ultherapy Prime", text: "The lifting effect is excellent. Very natural results with minimal recovery time. Highly satisfied!", platform: "Naver", rating: 5, date: "2024-01-05" },
      ],
    },
    facility: {
      ...
      images: [
        ...
        { label: "Consultation Area Detail", desc: "Private consultation space" },
      ],
  ...
  ja: {
    ...
    reviews: {
      ...
      nextLabel: "次へ",
      items: [
        { name: "キム・ミンジ", age: "32歳", treatment: "目の下脂肪再配置", text: "クマがとても酷かったのですが、施術後1ヶ月で目がぱっと明るくなりました。自然で満足です！", platform: "Naver", rating: 5, date: "2024-01-15" },
        { name: "イ・スジン", age: "28歳", treatment: "ピコレーザー", text: "シミが多かったのですが、3回の施術で大幅に改善されました。肌トーンも明るくなり満足です。", platform: "Naver", rating: 5, date: "2024-01-10" },
        { name: "パク・ジウン", age: "35歳", treatment: "ウルセラピープライム", text: "リフティング効果が本当に良いです。自然で回復期間も短いので良かったです。", platform: "Naver", rating: 5, date: "2024-01-05" },
      ],
    },
    facility: {
      sectionTitle: "施設案内",
      ...
      images: [
        ...
        { label: "相談室詳細", desc: "プライベートな相談スペース" },
      ],
  ...
  zh: {
    ...
    reviews: {
      ...
      nextLabel: "下一个",
      items: [
        { name: "金民智", age: "32岁", treatment: "眼袋脂肪重置", text: "我的黑眼圈非常严重，术后一个月眼睛就亮了起来。效果自然，非常满意！", platform: "Naver", rating: 5, date: "2024-01-15" },
        { name: "李秀珍", age: "28岁", treatment: "皮科激光", text: "我有很多色斑，3次治疗后改善明显。肤色也变亮了，很满意。", platform: "Naver", rating: 5, date: "2024-01-10" },
        { name: "朴智恩", age: "35岁", treatment: "欧活素提升疗法", text: "提升效果非常好。效果自然，恢复期也很短，非常满意！", platform: "Naver", rating: 5, date: "2024-01-05" },
      ],
    },
    facility: {
      sectionTitle: "设施介绍",
